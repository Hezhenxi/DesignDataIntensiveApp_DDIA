...
<a name="3irq-1739985401060"></a>[===数据密集型应用===](#nm5q-1706969255961)

<a name="tenn-1739985401062"></a>[第一部分 数据系统的基石](#unbe-1677787447006)

<a name="ccea-1739985401064"></a>[1.可靠性、可拓展性、可维护性能](#kwfx-1677787447007)

<a name="buuu-1739985401066"></a>[小结：一个应用必须满足各种需求才称得上有用](#zrzj-1642646974315)

<a name="rpxa-1739985401068"></a>[-功能性需求：CRUD](#lykw-1644227240038)

<a name="otk6-1739985401070"></a>[-非功能性需求：安全性，可靠性，合规性，可扩展性，兼容性和可维护性](#b2tu-1644227249556)

<a name="iurp-1739985401072"></a>[.可靠性：](#qqm5-1644227303238)

<a name="xlue-1739985401074"></a>[以为着即使发生故障，系统也能正常工作。](#vdpc-1699843965882)

<a name="vvuh-1739985401076"></a>[故障可能发生在硬件（通常是随机和不相关的）](#mk9e-1644227360160)

<a name="qrpk-1739985401078"></a>[软件（通常是系统性的bug,很难处理）](#w7by-1644227387308)

<a name="ffmw-1739985401080"></a>[人类（不可避免的时不时出错）](#dozl-1644227415061)

<a name="1txz-1739985401082"></a>[容错技术可以对终端用户隐藏某些类型的故障。](#fvz4-1644227444254)

<a name="2dtz-1739985401084"></a>[硬件故障](#7xms-1644228225080)

<a name="pna5-1739985401086"></a>[硬盘的平均无故障时间mean time to failure 约为10~50年](#3gfd-1708357730326)

<a name="jyjr-1739985401089"></a>[aws设计优先考虑灵活性flexibility 和 弹性 elasticity,而非单机可靠性，所以虚拟机实例不可用却无任何告警](#yusj-1708357802977)

<a name="kdi2-1739985401091"></a>[软件错误](#dfpv-1708357497902)

<a name="3noj-1739985401093"></a>[系统性错误 ](#ptxr-1708357908223)

<a name="xy3x-1739985401095"></a>[测量监控系统行为，运行时不断自检，出现差异desrepancy时报警](#ybic-1708358007856)

<a name="0qll-1739985401097"></a>[人为错误(如何让系统变得可靠)](#drpl-1708357507365)

<a name="y2w7-1739985401099"></a>[既然人类不可靠，如何让系统变得可靠：](#eb1v-1708358093033)

<a name="syp2-1739985401101"></a>[。最小化犯错机会的方式设计系统,  但如果限制太多，人们可能会忽略它们的好处而绕开，很难把握其中微妙的平衡](#i4we-1708358144376)

<a name="8m6e-1739985401103"></a>[。在易错地方和可能导致失效的地方解耦decouple,提供非生产环境沙箱sandbox-虚拟化环境，隔离真实系统进行安全测试](#xzfa-1708358243121)

<a name="rcec-1739985401105"></a>[。彻底的测试，单元测试，集成测试，手动测试，自动化测试覆盖边缘场景corner case.](#9jaa-1708358634289)

<a name="gqz7-1739985401107"></a>[。滚动发布，快速回滚](#zlp4-1708358698137)

<a name="l4fy-1739985401109"></a>[。配置详细和明确的监控](#40us-1708358954660)

<a name="z1fj-1739985401111"></a>[。良好的管理和充分的培训。一个复杂而重要的方面，但超出本书的范围](#o66x-1708358967000)

<a name="ytn5-1739985401113"></a>[可靠性有多重要](#x7co-1708357515795)

<a name="taiw-1739985401115"></a>[造成客户巨大损失-阿里云宕机造成的用户损失](#nc0w-1708358745350)

<a name="i9ds-1739985401117"></a>[家长将孩子照片存储在你的应用里，数据库损坏，客户有何体验，他们可能会知道如何从备份恢复吗？](#qopp-1708358856827)

<a name="k6tc-1739985401119"></a>[.可扩展性： ](#dsae-1708357483848)

<a name="i5gm-1739985401121"></a>[即使在增加负载的情况下也能保持性能的策略。](#t59j-1699843967201)

<a name="uvdm-1739985401123"></a>[定量描述负载和性能的方法。](#gqfn-1644228379215)

<a name="ssr5-1739985401125"></a>[推特主页时间线，介绍描述负载参数，并将响应时间百分点作为衡量性能的一种方式。头部阻塞、尾部延迟。](#krij-1644228405843)

<a name="khog-1739985401127"></a>[(有很多人通过将工作负载迁移到低延迟、自适应的GC来控制尾部延迟-infoQ java趋势)](#unxv-1739960162350)

<a name="kusp-1739985401129"></a>[在可扩展的系统中可以添加处理容量 以在高负载下保持可靠。](#bynr-1644228470161)

<a name="wyov-1739985401131"></a>[服务降级degradation的一个常见原因是负载的增加。](#eg4z-1708359118801)

<a name="dcx1-1739985401133"></a>[可拓展性Scalability是用来描述系统应对负载增长能力的术语。scalability: 可扩展性；可伸缩性；可量测性](#qd5r-1739959711621)

<a name="voc3-1739985401135"></a>[PS:scale  n.规模,刻度，大小     健合架构师说开关增减功能是可扩展性LOL](#dgno-1739959800409)

<a name="gicn-1739985401137"></a>[描述负载(tps-推特主页时间线扇出-查询性能优化)](#vja4-1708356470840)

<a name="r11k-1739985401139"></a>[描述性能](#s6un-1708356581594)

<a name="bmxh-1739985401141"></a>[吞吐量throughput](#fcez-1708523606684)

<a name="vjzb-1739985401143"></a>[响应时间 response time.](#k30f-1708523620292)

<a name="hfci-1739985401145"></a>[响应时间的高位百分点（也称为尾部延迟tail latencies](#bogk-1708523658968)

<a name="ujy8-1739985401147"></a>[.可维护性：（代码:设计模式  系统：检测健康性）](#k1dg-1708355783343)

<a name="sgdf-1739985401149"></a>[可操作性：人生苦短，关爱运维。](#mwlq-1739809481662)

<a name="hleq-1739985401151"></a>[简单性：管理复杂度](#zi2h-1739809499485)

<a name="hphr-1739985401153"></a>[可演化性：拥抱变化  ](#b64f-1739809505843)

<a name="rn8k-1739985401155"></a>[可维护性关于工程师和运维团队生活质量的。](#vg1v-1699843968229)

<a name="fnuz-1739985401157"></a>[良好的抽象降低复杂度，系统易于修改和适应新的应用场景。](#mq1x-1644231096441)

<a name="by7f-1739985401159"></a>[良好的可操作性对系统的健康状态具有良好的可见性，并拥有有效的管理手段。](#qj5f-1644228656997)

<a name="kndy-1739985401161"></a>[2.数据模型与查询语言](#jufm-1677787447008)

<a name="vduj-1739985401163"></a>[数据模型是软件开发中最重要的部分，选择一个合适的模型非常重要。](#moyn-1739958400668)

<a name="rdm0-1739985401165"></a>[多数应用是层次结构，如何使用低一层的数据模型表示:](#glyn-1739958437519)

<a name="4elx-1739985401167"></a>[1.开发人员用对象或数据结构API对现实世界对象进行建模](#itiw-1739958558955)

<a name="u3f2-1739985401169"></a>[2.存储选择：JSON，XML,关系型数据库中表、或图模型](#zst8-1739958597323)

<a name="43jl-1739985401171"></a>[3.数据库工程师选定内存、磁盘或网络字节来表示存储便于crud处理](#ndln-1739958769398)

<a name="llk1-1739985401173"></a>[4.硬件工程使用电流，脉冲，磁场等表示字节](#87e2-1739958841062)

<a name="hviy-1739985401175"></a>[关系模型与文档模型](#lynl-1739957541870)

<a name="fo0v-1739985401177"></a>[NoSQL的诞生](#8vxs-1739957588389)

<a name="jo7v-1739985401179"></a>[对象关系不匹配](#ciyc-1739957588391)

<a name="vf2a-1739985401181"></a>[多对-和多对多的关系](#rdhn-1739957588393)

<a name="czzd-1739985401183"></a>[文档数据库是否在重蹈覆辙?](#ejgi-1739957588395)

<a name="9wpz-1739985401185"></a>[网络模型](#ftqi-1739957588397)

<a name="mm5x-1739985401187"></a>[关系模型](#jxjx-1739957588399)

<a name="nowx-1739985401189"></a>[与文档数据库相比](#dgpl-1739957588401)

<a name="gnux-1739985401191"></a>[关系型数据库与文档数据库在今日的对比](#yecy-1739957588403)

<a name="dvcs-1739985401193"></a>[哪个数据模型更方便写代码?](#3kqq-1739957588405)

<a name="ciuz-1739985401195"></a>[文档模型中的架构灵活性](#ablj-1739957588407)

<a name="iv11-1739985401197"></a>[查询的数据局部性](#gre0-1739957588409)

<a name="i4fx-1739985401199"></a>[文档和关系数据库的融合](#oswg-1739957588411)

<a name="balw-1739985401201"></a>[数据查询语言](#hicx-1739957588413)

<a name="zxzo-1739985401203"></a>[Web上的声明式查询](#3nio-1739957588415)

<a name="osfh-1739985401205"></a>[MapReduce查询](#19wu-1739957588417)

<a name="z594-1739985401207"></a>[图数据模型](#ow5x-1739957588419)

<a name="47sr-1739985401209"></a>[属性图](#p6tp-1739957588421)

<a name="xdhz-1739985401211"></a>[Cypher查询语言](#xrco-1739957588423)

<a name="w0z5-1739985401213"></a>[SQL中的图查询](#wlr2-1739957588425)

<a name="g30q-1739985401215"></a>[三元组存储和SPARQL](#cqog-1739957588427)

<a name="p7mg-1739985401217"></a>[语义网络](#z8sp-1739957588429)

<a name="2lt6-1739985401219"></a>[RDF数据模型](#bqfx-1739957588431)

<a name="lr08-1739985401221"></a>[SPARQL查询语言](#rbsb-1739957588433)

<a name="vxho-1739985401223"></a>[基础:Datalog](#u7qx-1739957588435)

<a name="xagi-1739985401225"></a>[本章小结：](#auej-1739957588437)

<a name="q4fj-1739985401227"></a>[-关系模型](#pgu6-1699844351041)

<a name="ewbi-1739985401229"></a>[-NoSql (es,redis)](#kfpd-1644410618294)

<a name="0u6z-1739985401231"></a>[1.文档数据库:MongoDB](#0p23-1644410807294)

<a name="svaw-1739985401233"></a>[  2.图形数据库 ：](#09bl-1644410666587)

<a name="okv8-1739985401235"></a>[-其它模型(基因序列)](#6fxw-1644410924417)

<a name="dsov-1739985401237"></a>[3.存储与检索](#sm0u-1677787447009)

<a name="hjk1-1739985401239"></a>[-优化事务处理（OLTP）transaction ](#bhcv-1644935436804)

<a name="f3qe-1739985401241"></a>[1.OLTP系统通常面向用户，大量的请求。](#tbhw-1699844517372)

<a name="tzyy-1739985401243"></a>[2.磁盘寻道时间往往是这里的瓶颈。](#fnev-1644935714127)

<a name="ss6u-1739985401245"></a>[3.应用程序使用某种键来请求记录，存储引擎使用索引来查找所请求额键的数据。](#cjwp-1644935609899)

<a name="4nsw-1739985401247"></a>[-优化分析（OLAP）analys](#jg7s-1699844443567)

<a name="2z1o-1739985401249"></a>[1.列式储存(投影操作，压缩技术，聚合过滤)](#pjd1-1703887811615)

<a name="szgd-1739985401251"></a>[-OLTP两大主流学派的存储引擎：](#8sgm-1644935924013)

<a name="sxs2-1739985401253"></a>[1.日志结构学派](#i55y-1644935943748)

<a name="goue-1739985401255"></a>[2.就地更新学派](#h3il-1644935977285)

<a name="3plw-1739985401257"></a>[4.编码（序列化）与演化(XML,JSON,CSV)](#lbs1-1677787447010)

<a name="sohf-1739985401259"></a>[第二部分 分布式数据](#4p9n-1677787447012)

<a name="xg6q-1739985401261"></a>[1.高可用性/容错](#o4ag-1646310813851)

<a name="bxlg-1739985401263"></a>[2.断开连接的操作](#snwm-1646310894841)

<a name="1gkm-1739985401265"></a>[3.减少延迟(节点近)](#evly-1646310918322)

<a name="4xrw-1739985401267"></a>[4.可拓展性](#itsh-1646310968967)

<a name="gmex-1739985401269"></a>[.拓展至更高的载荷](#gjis-1708362947856)

<a name="hqrw-1739985401271"></a>[垂直扩展scale up ：购买更强大的机器 cpu](#mgia-1708362999715)

<a name="htih-1739985401273"></a>[共享内存架构shared-memory architecture：许多处理器、内存和磁盘再同一操作系统下相互连接，共享内存和磁盘](#pdo8-1708363038596)

<a name="je38-1739985401275"></a>[共享磁盘share-disk architecture：独立处理器和内存，数据存储在机器之间共享的磁盘阵列上，磁盘通过快速网络连接。数仓](#wgwl-1708363065800)

<a name="54fq-1739985401277"></a>[无共享架构](#klw2-1708363340866)

<a name="zlvz-1739985401279"></a>[.复制VS分区](#gbgq-1646311175182)

<a name="oanq-1739985401281"></a>[5.复制](#gd4q-1708363438406)

<a name="rnpe-1739985401283"></a>[.领导者与追随者-单主复制](#9hbs-1708441077626)

<a name="ygju-1739985401285"></a>[客户端将所有写入操作发送到单个节点（领导者），该结点将数据更改事件流发送到其它副本（追随者）。](#aucb-1708528116000)

<a name="vilc-1739985401287"></a>[读取可以再任何副本中执行，但从追随者读取可能是陈旧的 （最终一致性问题）](#wgge-1646311567456)

<a name="8dqc-1739985401289"></a>[.同步复制与异步复制](#cbey-1646310922523)

<a name="45y7-1739985401291"></a>[.设置新从库(快照复制+caught up binlog)](#j5o0-1704983008475)

<a name="fzcm-1739985401293"></a>[.处理宕机节点](#bcod-1708442233018)

<a name="lbco-1739985401295"></a>[从库失效：追赶恢复](#5ufz-1708443850274)

<a name="wh82-1739985401297"></a>[主库失效：故障切换failover](#udix-1708443860752)

<a name="rcpz-1739985401299"></a>[自动切换步骤：1.确认主库失效](#w3sj-1708523445192)

<a name="frhg-1739985401301"></a>[2.选举新主库：共识](#y3qn-1708523480847)

<a name="0tqs-1739985401303"></a>[3.配置系统启用新主库](#wua6-1708523497956)

<a name="a2qf-1739985401305"></a>[failover的麻烦：1.异步复制数据丢失](#z7mn-1708523814309)

<a name="7kqz-1739985401307"></a>[2.自增主键冲突](#mnjx-1708523836932)

<a name="5a53-1739985401309"></a>[3.脑裂split brain](#dbhg-1708523873194)

<a name="w8yn-1739985401311"></a>[4.如何设置超时](#561v-1708523878338)

<a name="cyok-1739985401313"></a>[.复制日志的实现](#8mem-1708442228760)

<a name="9hpd-1739985401315"></a>[基于语句的复制(每个写入请求语句statment)](#k8yo-1708524004340)

<a name="pin9-1739985401317"></a>[记录每个写入请求语句statment，语句日志传输给从库](#hcqe-1708524155632)

<a name="inbh-1739985401319"></a>[问题：非确定函数nondeterministic, NOW()  RAND()](#9xml-1708524182083)

<a name="c046-1739985401321"></a>[    自增列- 造成差异](#il4a-1708524271564)

<a name="llzx-1739985401323"></a>[副作用的语句：用户自定义函数，触发器，存储过程](#azmh-1708524331636)

<a name="tqc8-1739985401325"></a>[解决: 用固定值替换](#rcfb-1708524371120)

<a name="czjm-1739985401327"></a>[  如语句存在任何不确定性，切换到基于行的数据](#6uy2-1708524426849)

<a name="ysgc-1739985401329"></a>[传输预写式日志(WAL)](#rnmz-1708524013585)

<a name="99h8-1739985401331"></a>[日志存储引擎SSTables LSM树](#hze4-1708524498278)

<a name="4u4n-1739985401333"></a>[磁盘块的B树  WAL, 崩溃恢复](#qzop-1708524541132)

<a name="eotw-1739985401335"></a>[逻辑日志复制(基于行)](#a3ng-1708524040960)

<a name="gknz-1739985401337"></a>[binlog](#jiiu-1708524648209)

<a name="579s-1739985401339"></a>[基于触发器的复制](#ezoi-1708524083973)

<a name="lsex-1739985401344"></a>[.复制延迟问题(解决方法都是反分布式，或者趋于单机一致性。数据一致性模型：https://jepsen.io/consistency)](#https://jepsen.io/consistency)

<a name="dnuy-1739985401346"></a>[读己之写(读主库或带写时间戳查询)](#w5nz-1708525244967)

<a name="ea6p-1739985401348"></a>[写后从旧副本读取数据-未同步  ](#25nj-1708526407050)

<a name="h0xx-1739985401350"></a>[解决：写后读read after write 一致性 或叫做 read your write consistency 防止这种异常](#4st1-1708525569674)

<a name="zp3l-1739985401352"></a>[1.都从主库读。适用仅由用户本人编辑的数据，如个人信息。大部分内容从主库读不适用，扩容读无效果](#v4r0-1708525736897)

<a name="90ry-1739985401354"></a>[2. 扩容读需要保证更新时间，监控复制延迟，防止滞后超过一分钟从从库发出查询](#vqjs-1708525818133)

<a name="ilpk-1739985401356"></a>[3. 客户端记录写入时间戳，系统确保从库提供查询时，版本时间已覆盖，否则从另一个从库读，或者等待caught up-  等待不就相当弱可用状态，且时钟不可靠](#nmrh-1708525971734)

<a name="b3fg-1739985401358"></a>[4. 副本在多个数据中心，复杂度高，都需经过主库IDC](#wmu9-1708526095856)

<a name="bbrk-1739985401360"></a>[单调读(基于id散列路由同一副本)](#kwrd-1708525264596)

<a name="ckah-1739985401362"></a>[先读到最新副本，后读到旧副本感觉数据消失](#npwe-1708527802311)

<a name="urgq-1739985401364"></a>[A看到B评论后消失，时光倒流moving backward in time ](#4cn0-1708526272081)

<a name="btmz-1739985401366"></a>[解决：单调读monotonic reads总是从同一个副本进行读取(基于用户散列id，如果副本失效则重新路由)](#drqk-1708526396300)

<a name="dbpk-1739985401368"></a>[  比强一致性(同步复制/类比单机)弱，比最终一致性更强](#s6u3-1708526566643)

<a name="xgmg-1739985401370"></a>[一致前缀读(因果关系写到相同分区)](#bfps-1708525268614)

<a name="tecj-1739985401372"></a>[consistent prefix reads](#q7p0-1711363121071)

<a name="du9c-1739985401374"></a>[不同分片副本同步先后问题导致读顺序错误](#rqcm-1708527879976)

<a name="5qss-1739985401376"></a>[分区partition/分片sharded数据库中的一个特殊问题，全局写入顺序](#bwov-1708526677620)

<a name="bb5e-1739985401378"></a>[分区主库1写入 A:你吃饭了吗？ 分区主库2写入B:没有。 分区1副本同步主库1落后分区2副本同步主库2    C读取1副本: 没有，后读取2副本。你吃饭了吗？](#7e9o-1708526727984)

<a name="mkza-1739985401380"></a>[解决：确保因果关系都写入到相同分区](#turn-1708527108521)

<a name="t5xf-1739985401382"></a>[复制延迟解决方案](#a2la-1708525420248)

<a name="uo06-1739985401384"></a>[趋于反分布式，局部或者部分看做一个单机，做到强一致性](#x8ng-1708527233293)

<a name="hmpg-1739985401386"></a>[写后读。](#gecf-1708527304184)

<a name="zykh-1739985401388"></a>[数据库通过事务提供强大保证。](#zsq6-1708527307246)

<a name="e9nl-1739985401390"></a>[.多主复制(主主复制，互为副本-写冲突。多主复制被认为是危险的领域)](#pbfd-1708528009698)

<a name="lus7-1739985401392"></a>[多主复制的应用场景](#kxkx-1708441627686)

<a name="mlmd-1739985401394"></a>[运维多个数据中心(IDC-主主间复制需要处理写冲突）](#xrso-1708700002291)

<a name="0wfg-1739985401396"></a>[性能(多活配置，写操作在本地IDC处理，其他IDC异步复制，性能更好)](#06t6-1708700132681)

<a name="bl26-1739985401398"></a>[容忍IDC停机](#9sww-1708700267631)

<a name="yoyo-1739985401400"></a>[容忍网络问题(临时的网络中断不会妨碍正在写入的处理)](#dtkl-1708700295371)

<a name="tuwr-1739985401402"></a>[需要离线操作的客户端(支持多个终端离线操作couchDB)](#knxa-1708700020273)

<a name="d2ov-1739985401404"></a>[协同编辑](#hvwb-1708700115895)

<a name="gjjl-1739985401406"></a>[处理写冲突(A将标题从1改2,B将1改3)](#fdot-1708700612321)

<a name="g9gs-1739985401408"></a>[同步于异步冲突检测](#u8bc-1708700824251)

<a name="zifv-1739985401410"></a>[同步：单主程序复制 - 不允许每个副本独立接受写入](#wfgd-1708700957597)

<a name="xrmm-1739985401412"></a>[异步：独立接受写入- 异步检测，但为时已晚](#x6is-1708701017804)

<a name="nzi9-1739985401414"></a>[避免冲突(特定记录写入都通过同一个领导者，主库切换或者用户迁移至更近的主库时会有同时写入的可能性)](#xg2a-1708700840681)

<a name="zfoh-1739985401416"></a>[收敛convergent至一致的状态(副本主库和其副本在复制完成时收敛至一个相同的最终值)](#ucfn-1708700844474)

<a name="nhlc-1739985401418"></a>[最后写入胜利LWW,last write wins- 给每个写入一个唯一id, 挑选最高ID的写入作为胜利者，并丢弃其他写入-数据丢失](#cbla-1708701376316)

<a name="drbs-1739985401420"></a>[为每个副本分配一个唯一ID,ID编号更高的具有高优先级。数据丢失](#40po-1708701481447)

<a name="24gz-1739985401422"></a>[将值合并在一起](#p4m4-1708701593939)

<a name="3jsa-1739985401424"></a>[记录冲突，并编写解决逻辑代码。如通过提醒用户方式](#8fcs-1708701611999)

<a name="zyqr-1739985401426"></a>[自定义冲突解决逻辑](#yrdi-1708700860148)

<a name="8wfu-1739985401428"></a>[自定义冲突解决逻辑(complex)](#t4i7-1708702160004)

<a name="l86c-1739985401430"></a>[写时执行-后台处理](#pdql-1708702370625)

<a name="u76r-1739985401432"></a>[读时执行-提供多版本用户选择，回写数据库](#sksk-1708702376293)

<a name="inew-1739985401434"></a>[亚马逊购物车移除的商品重新出现](#4bqp-1708702425059)

<a name="d7io-1739985401436"></a>[什么是冲突(两个领导者预订同一个会议室，7章看冲突实例12章看检测解决)](#6x4i-1708700867996)

<a name="aokl-1739985401438"></a>[多主复制拓扑](#o41a-1708702111509)

<a name="qege-1739985401440"></a>[环形，星型，all to all -mysql仅支持环形](#5feh-1708702903239)

<a name="dwxk-1739985401442"></a>[问题：多主复制时，可能在某些副本中写入错误的顺序。like A写主库1，B写主库2，主库3先同步2，再同步1。类似一致前缀读。](#ddyu-1708702949257)

<a name="hgy2-1739985401444"></a>[解决：时间戳是不够的-不可靠时钟，使用一种称为版本向量(version vectors)的技术-检测并发写入](#ghp3-1708703247102)

<a name="xvx4-1739985401446"></a>[无主复制leaderless](#bfz8-1708759285067)

<a name="nt2d-1739985401448"></a>[Amazon的Dynomo系统。](#cvru-1708759359537)

<a name="qbnr-1739985401450"></a>[Riak, Cassandra，Voldmort 也称为Dynamo风格。](#wf6o-1708759707666)

<a name="ynef-1739985401452"></a>[类型1：客户端直接将写入发送到几个副本中](#xpqf-1708760120711)

<a name="htxi-1739985401454"></a>[类型2：coordinator协调者节点代表客户端写入。](#pl2z-1708760121090)

<a name="wgid-1739985401456"></a>[当节点故障时写入数据库(仲裁写⼊，法定读取，并在节点中断后读修复。)](#qgpe-1708760989905)

<a name="atcj-1739985401458"></a>[如果主从复制，主故障/重启系统更新 则需进行故障切换](#zfuz-1708760396929)

<a name="hbuv-1739985401460"></a>[无主复制： userA set piture_url   -> replica1 ok    Then version=7](#3soj-1708760452090)

<a name="8q4p-1739985401463"></a>[           user set piture_url   -> replica2 ok  Then version=7](#4f05-1708760543198)

<a name="nidv-1739985401465"></a>[user set piture_url   -> replica3 offline  fail   version= 6](#ynls-1708759898772)

<a name="cxtv-1739985401467"></a>[    userB get piture  :  rp3(version6) rp1(version7)  rp2(version7)  Than fix rp3 value to version7](#e1ur-1708760618873)

<a name="owjs-1739985401469"></a>[ 读修复和反熵(失效节点重新连机后如何caught up)](#tyv3-1708760780373)

<a name="voay-1739985401471"></a>[读修复like userB get piture fixed rp3](#wjho-1708761214792)

<a name="rd8a-1739985401473"></a>[反熵 后台进程不断查找副本之间的数据差异。Voldmort无反熵过程，副本可能丢失数据](#xblj-1708761286988)

<a name="1sbs-1739985401475"></a>[ 读写的法定人数（仲裁）](#w3ia-1708761120623)

<a name="qdc8-1739985401477"></a>[仲裁一致性的局限性-最终一致，更强的保证需要事务或共识](#oj1i-1708759830121)

<a name="wvc4-1739985401479"></a>[松散法定人数与带提示的接力](#cu5q-1708759841416)

<a name="gwjc-1739985401481"></a>[运维多个数据中心-将写入发送到所有副本，仅需本地IDC内法定节点确认](#kzki-1708761744887)

<a name="fwbn-1739985401483"></a>[检测并发写入](#pt1k-1708759856530)

<a name="yjik-1739985401485"></a>[Dynamo风格的数据存储，没有明确定义的顺序。](#mu89-1708761978075)

<a name="diab-1739985401487"></a>[userA set x=A   get x](#dbni-1708763823783)

<a name="dul3-1739985401489"></a>[rp 1 A ok    B unresponsive   A](#auce-1708763993783)

<a name="j8cf-1739985401491"></a>[rp2 A ok   B OK  B](#kteo-1708764011894)

<a name="lbqk-1739985401493"></a>[rp3 B ok A ok A](#9xyy-1708764019308)

<a name="naly-1739985401495"></a>[userB set x=B ](#esiv-1708702764305)

<a name="vaud-1739985401497"></a>[最后写入胜利(丢弃并发写入)](#wd1i-1708764197180)

<a name="obyt-1739985401499"></a>[LLW 无法确定真实排序，强制排序，选择最新的最大时间戳，并丢弃较早的任何写入.Cassandra唯一支持的方式，Riak可选](#uzhw-1708874432788)

<a name="0oxg-1739985401501"></a>[缺点：数据丢失 ](#henp-1708874594301)

<a name="lmwx-1739985401503"></a>[此前发生的关系和并发](#hzwp-1708764215825)

<a name="ewo0-1739985401505"></a>[因果依赖(causally dependent)  如果B后发与A, 则B因果依赖A, ](#3wp0-1708874672763)

<a name="wdlz-1739985401507"></a>[如果是并发，则存在需要解决的冲突](#1wzv-1708875051673)

<a name="fwtd-1739985401509"></a>[捕获此前发生的关系](#j2r6-1708764228505)

<a name="qvc3-1739985401511"></a>[捕获两个客户端间的因果关系，同时编辑购物车(示例为单副本)](#vv7q-1708875756229)

<a name="5pio-1739985401513"></a>[合并同时写入的值](#zp0i-1708874374616)

<a name="jdgb-1739985401515"></a>[客户端需额外工作，合并并发写入的值来擦屁股。Riak称这些并发值兄弟(sibings)](#wawo-1708876272614)

<a name="zs42-1739985401517"></a>[版本向量](#arlv-1708874381589)

<a name="usfr-1739985401519"></a>[所有副本的版本号集合称为版本向量(version vector)](#b1ov-1708700703636)

<a name="ydjg-1739985401521"></a>[6.分区](#dyz5-1709800112532)

<a name="bbiq-1739985401523"></a>[.分区与复制(分区与复制方案是独立的)](#twd1-1709800204792)

<a name="9pai-1739985401525"></a>[.键值数据的分区](#fbqg-1709800263679)

<a name="f0nd-1739985401527"></a>[偏斜skew：分区过多数据或过多查询](#s7ju-1709801062977)

<a name="ulrh-1739985401529"></a>[热点hot spot:高负载的分区](#u0d3-1709801107270)

<a name="worx-1739985401531"></a>[根据键的范围分区](#lqbu-1709800332210)

<a name="tsti-1739985401533"></a>[Bigtable, HBase, RethinkDB 和 MongoDB2.4](#i2ju-1709801151406)

<a name="ysec-1739985401535"></a>[按照一定的顺序保存键（SSTbale和LSM-树）](#np00-1709801582805)

<a name="xz2t-1739985401537"></a>[按时间分区当日写过载（需加传感器保证日期+传感主键均匀分布）](#evhb-1709801683166)

<a name="esxz-1739985401539"></a>[根据键的散列分区(可将偏斜数据均匀分布)](#a1yy-1709800347130)

<a name="eyeg-1739985401541"></a>[不适合分区的简单哈希函数：java .hashCode-同键不同进程不同哈希值](#mdg4-1709801628016)

<a name="remb-1739985401543"></a>[一致性哈希consistent hashing:哈希键分区边界均匀间隔，也可伪随机选择（CDN均匀分配负载）。](#7rkg-1709802019859)

<a name="k8zj-1739985401545"></a>[缺点：无序，低效范围查询(需发送到所有分区)](#iktb-1709802309508)

<a name="9uoo-1739985401547"></a>[折中方案：复合主键/组合索引。(uid,time).不同用户在不同分区，每个用户按时间搓顺序存储在单个分区上。](#zznq-1709802490074)

<a name="bx2n-1739985401549"></a>[负载倾斜与消除热点](#ed70-1709800357523)

<a name="x4mf-1739985401551"></a>[数百万追随者做某事-大量写入同一个键](#403a-1709802593546)

<a name="lta4-1739985401553"></a>[解决：火爆主键+随机数即可将主键分散为100个分区](#wx5s-1709802730512)

<a name="nyvd-1739985401555"></a>[缺点：数据合并，跟踪火爆主键。需权衡利弊。](#h0b7-1709802773377)

<a name="mxgy-1739985401557"></a>[.分片与次级索引](#ekdv-1709800287975)

<a name="yusc-1739985401559"></a>[次级索引通常并不能唯一标识记录。](#n3vk-1709803239471)

<a name="ac25-1739985401561"></a>[HBase Volde-mort为了减少实现复杂度放弃了次级索引。](#q1u5-1709803293988)

<a name="o4nn-1739985401563"></a>[Riak开始添加， 次索是Solr Elasticesearch 搜索的基石](#fhpr-1709803333585)

<a name="3yjr-1739985401565"></a>[按文档的二级索引](#mwm0-1709800370635)

<a name="xyqb-1739985401567"></a>[文档分区索引/本地索引](#ud7o-1709803718409)

<a name="kgge-1739985401569"></a>[每个分区独立维护自己的二级索引。](#zlhf-1709803740582)

<a name="00v7-1739985401571"></a>[查询发送所有分区，并合并所有返回结果，分散/聚集scatter/gather-容易导致尾部延迟放大。](#bkj3-1709803789802)

<a name="1mk2-1739985401573"></a>[缺点：可能使二级索引读取查询相当昂贵。](#ghpm-1709803878421)

<a name="4yi0-1739985401575"></a>[根据关键词(Term)的二级索引](#itl0-1709800380617)

<a name="ivid-1739985401577"></a>[全局索引：覆盖所有分区数据的索引，也须分区。](#8bw4-1709804016790)

<a name="lswq-1739985401579"></a>[关键词分区：关键词本身或它的散列进行分区。](#qc2d-1709913637902)

<a name="gpai-1739985401581"></a>[优点：只需请求包含关键词的分区，读取更有效率](#jmj8-1709913775261)

<a name="vuaw-1739985401583"></a>[缺点：写入慢且复杂。需支持分布式事务。](#i7kp-1709913825503)

<a name="nsdk-1739985401585"></a>[理想下总是最新，实践中更新通常为异步。Amazon DynamoDB声称全局次级索引不到1s内更新。](#mv7j-1709913923874)

<a name="sf0k-1739985401587"></a>[.分区再平衡(reblancing)](#hpnd-1709800294747)

<a name="eun6-1739985401589"></a>[吞吐量增加：加cpu](#1f0n-1709914101899)

<a name="zxb2-1739985401591"></a>[数据集大小增加：加磁盘和RAM](#vjb0-1709914129763)

<a name="4n4e-1739985401593"></a>[机器故障：其他机器接管](#smcd-1709914153882)

<a name="dexi-1739985401595"></a>[----------再平衡应满足--------------](#2efu-1709916803909)

<a name="7mzt-1739985401597"></a>[发生时：数据库应该继续接受读取和写入](#20wj-1709916807951)

<a name="1ca2-1739985401599"></a>[节点之间只移动必须数据(分区)，以便快速再平衡，减少网络和磁盘io负载。](#cxoi-1709916893371)

<a name="xqfm-1739985401601"></a>[平衡后：存储，读取和写入公平共享](#cj8j-1709916938075)

<a name="76e9-1739985401603"></a>[平衡策略](#cavd-1709800402611)

<a name="1wxk-1739985401605"></a>[反面教材：hash mod N](#6f6z-1709800409866)

<a name="2wgl-1739985401607"></a>[$hash(key)=22  22mod10..2  22mod 11...0  22 mod 9 ...4 ](#anib-1709916997775)

<a name="y4t0-1739985401609"></a>[节点需要转移秘钥及次数过多，过于昂贵。](#anz7-1709917243580)

<a name="2lpa-1739985401611"></a>[解决：更换为只移动必须数据的方法。](#7ytl-1709917334275)

<a name="9usn-1739985401613"></a>[固定数量的分区(加节点时分配分区)](#8l9j-1709800420954)

<a name="tfql-1739985401615"></a>[新增/减少节点时，将现存部分数据转移到节点新增/现存节点(Riak,es,couchbase Voldemort使用这种再平衡）](#vmsm-1709917322722)

<a name="6kjk-1739985401617"></a>[适用：分区数量第一次建立时确定。](#ktrd-1709917648400)

<a name="9zku-1739985401619"></a>[缺点：数据集总量大小难以预估时；分区大再平衡代价昂贵，分区小产生额外开销。](#vw7j-1709917692466)

<a name="0msm-1739985401621"></a>[分区大小与集群数据总量成比例增长](#eszc-1709921747523)

<a name="mu2p-1739985401623"></a>[动态分区(适用键范围的分区)](#tkjw-1709800428033)

<a name="s0az-1739985401625"></a>[解决：使用键范围分区，固定边界的固定数量的分区不便。出现边界错误，手动重新去配分区边界将非常繁琐。](#itsg-1709917825657)

<a name="xldo-1739985401627"></a>[动态分区：与B树类似，分区数据增长超过配置时将分成两区，大量数据删除分区缩小低于阈值则合并(HBase RethinkDB)](#05rm-1709917996703)

<a name="vwjk-1739985401629"></a>[优点：分区数量适应总数据量-动态划分分区数量。](#v8uv-1709918235496)

<a name="i2dd-1739985401631"></a>[注意：空库分区开始，未绘制边界先验信息。所有写操作都必须由单个节点处理。其它节点空闲](#cdjv-1709918375629)

<a name="dxr8-1739985401633"></a>[解决：配置一组初始分区-预分割 Hbase MongoDb。配需提前知道键分配方式。](#3uee-1709918458100)

<a name="d4jb-1739985401635"></a>[MongoDB同时支持范围和哈希分区且动态分割分区。](#tlmq-1709918504615)

<a name="qjg7-1739985401637"></a>[分区数量与数据集大小成正比](#xqee-1709921516740)

<a name="ymy7-1739985401639"></a>[按节点比列分区](#kcsr-1709800432396)

<a name="qqgr-1739985401641"></a>[新增节点，分区将变小。随机选择固定数量的现有分区进行拆分,最终获得公平的负载份额。cassandre ketama.](#xscz-1709920011051)

<a name="f2cj-1739985401643"></a>[随机选择分区边界要求使用基于散列的分区-一致性哈希。](#pmpc-1709920187661)

<a name="o3wb-1739985401645"></a>[分区数量与节点数量无关](#a0l0-1709923420226)

<a name="89t0-1739985401647"></a>[ 运维：手动还是自动平衡](#w6ob-1709800443454)

<a name="rkgn-1739985401649"></a>[自动：与故障检测结合将十分危险，高负载节点响应慢被视为死亡被踢掉，重新平衡集群时其他超负荷节点可能级联失败](#qobk-1709920292898)

<a name="q0ua-1739985401651"></a>[手动人为监控+自动](#a05n-1709920414620)

<a name="ygad-1739985401653"></a>[.请求路由](#qxk3-1709800301840)

<a name="txw7-1739985401655"></a>[分区再平衡后的服务发现(IP 端口)](#sd2e-1709921854453)

<a name="hbwp-1739985401657"></a>[-------方案-------](#gliq-1709921964410)

<a name="jowr-1739985401659"></a>[1.循环策略：Round-Robin load balancer，轮询节点看是否有请求的分区。](#ibln-1709921978507)

<a name="fyju-1739985401661"></a>[2.路由层：有中间层的路由决定请求的节点，由路由层负载均衡](#gjxa-1709922094115)

<a name="iap7-1739985401663"></a>[3.要求客户端知道分区和节点的分配。客户端可直连节点。](#ukz9-1709922149547)

<a name="kzib-1739985401665"></a>[具有挑战性的问题。重要的是所有参与者都同意-否则将被发送到错误的节点，而不是正确处理。分布式中的共识协议-但很难正确实现。](#1c54-1709922244119)

<a name="8zzk-1739985401667"></a>[Zookeper分区分配改变时通知路由层保持最新信息。](#c7dc-1709922373821)

<a name="zuws-1739985401669"></a>[LinkedIn的Espressor使用Heix进行集群管理(依靠Zookeeper）](#ne7u-1709922442881)

<a name="vhnr-1739985401671"></a>[Hbase,SolrCloud 和kafka也是用Zookeeper来跟踪分区分配。](#41cr-1709922584212)

<a name="gicp-1739985401673"></a>[Cassandra  Riaks节点间使用留言协议gossip protocol来传播群集状态变化。请求发送任意节点，该节点转发到含有请求分区的节点。模型增加数据库节点的复杂性。但避免对Zookeeper这类外部协调服务的依赖](#kg5k-1709922347652)

<a name="0lcw-1739985401675"></a>[Couchbash不会自动再平衡，简化了设计。moxi路由层。](#uohs-1709922928889)

<a name="ojf7-1739985401677"></a>[执行并行查询](#h26t-1709800460759)

<a name="d3t3-1739985401679"></a>[大规模并行处理(MPP,massively parallel processing)-数仓](#oj8k-1709923010027)

<a name="h8lv-1739985401681"></a>[7.事务](#7qvp-1708523954496)

<a name="72pw-1739985401683"></a>[简化故障失败的机制-强大的事务！！](#wk3n-1710172857428)

<a name="sueh-1739985401685"></a>[故障](#pzui-1710172844274)

<a name="vsdr-1739985401687"></a>[崩溃](#znoj-1710172848152)

<a name="klob-1739985401689"></a>[网络中断](#vovu-1710172885568)

<a name="hl2o-1739985401691"></a>[多线程/客户端写入覆盖](#sxty-1710172894683)

<a name="pzqx-1739985401693"></a>[读取无意义中间态数据](#hbqy-1710172933218)

<a name="ujg0-1739985401695"></a>[多线程/客户端竞争](#jlng-1710172974900)

<a name="t9mv-1739985401697"></a>[.事务的棘手概念](#58hv-1710167822460)

<a name="wti9-1739985401699"></a>[ACID的含义](#yxrp-1710167867782)

<a name="bl9t-1739985401701"></a>[原子性atomicity](#hryj-1710167943276)

<a name="qo23-1739985401703"></a>[一致性consistency](#9aal-1710167983379)

<a name="fjwz-1739985401705"></a>[—致性这个词重载的很厉害:](#jkse-1710173130714)

<a name="qmme-1739985401707"></a>[隔离性isolation](#gfkv-1710171645686)

<a name="scwf-1739985401709"></a>[持久性durability](#7kja-1710171663168)

<a name="cdko-1739985401711"></a>[单对象与多对象操作](#pblh-1710167919896)

<a name="gylk-1739985401713"></a>[违反隔离性：一个事务读取另一个事务未被执行的写入（脏读）](#42qx-1710250188446)

<a name="fd5b-1739985401715"></a>[ 原⼦性确保发⽣错误时，事务先前的任何写⼊都会被撤消，以避免状态不⼀致（all or nothing）](#daxd-1710250201202)

<a name="45wh-1739985401717"></a>[单对象写入](#7ymn-1710171710772)

<a name="zjc4-1739985401719"></a>[单对象写入崩溃，原子性通过日志实现恢复](#h5aa-1710250215106)

<a name="4mci-1739985401721"></a>[原子操作：CAS也是流行的操作](#ihdr-1710250368749)

<a name="vhlb-1739985401723"></a>[事务通常被理解为：将多个对象上的多个操作合并为一个执行单元的机制](#a1qj-1710250481310)

<a name="38y4-1739985401725"></a>[多对象事务的需求](#afyc-1710171718578)

<a name="yhfm-1739985401727"></a>[是否需要多对象事务？ ](#t9gh-1710251706186)

<a name="5j3y-1739985401729"></a>[是否有可能只用键值模型和单对象来实现应用程序？](#9b6e-1710251739137)

<a name="6kez-1739985401731"></a>[ 关系型数据库：多表关联插入操作](#ormg-1710250533532)

<a name="3tbu-1739985401733"></a>[ 文档数据模型：多个字段常在同一个文档(被视为单个对象），缺乏连接功能的文档DB会鼓励非规范化(操作非规范化信息需要更新多个文档)。事务可防止非规范化数据不同步。](#opfe-1710250566216)

<a name="x9i1-1739985401735"></a>[ 二级索引的数据库中：一二级索引的同步更新](#syt6-1710251863622)

<a name="6gtk-1739985401737"></a>[无原子性:复杂的错误处理](#ymgi-1710251891615)

<a name="ikzl-1739985401739"></a>[无隔离性：并发问题](#ovhl-1710251918119)

<a name="vk7m-1739985401741"></a>[处理错误和中止](#g5o1-1710171723084)

<a name="bzdg-1739985401743"></a>[···   ACID哲学：违反规则宁可放弃，不留半成品。](#ygfp-1710251941752)

<a name="shld-1739985401745"></a>[无主复制则是尽力而为：数据库将做尽可能多的事。错误时不会撤销已经完成的事。-错误恢复是应用程序的责任。](#0hze-1710252188073)

<a name="v2qo-1739985401747"></a>[Rails的ActiveRecord、Django这样的orm框架不会重试中断的事务。丢弃用户输入。](#7mbo-1710252298563)

<a name="4jxe-1739985401749"></a>[中止的重点应该是允许安全的重试。但它并不完美：](#p2mf-1710253466041)

<a name="5vp5-1739985401751"></a>[事务成功，网络故障可能导致执行两次。除非有额外应用级除重机制。](#lmfw-1710253530673)

<a name="icco-1739985401753"></a>[负载过大，重试将更槽糕。限制重试次数，指数退避算法。并单独处理和过载相关的错误](#nxyx-1710253675080)

<a name="tybc-1739985401755"></a>[仅在临时性错误才值得重试（死锁，异常，网络中断和切换）。发生永久性错误的重试是无意义的](#njy9-1710253740189)

<a name="px90-1739985401757"></a>[数据库外的副作用：重试每次重发电子邮件。不同系统事务。两阶段提交2PC.](#auy9-1710253799114)

<a name="2krn-1739985401759"></a>[ 客户端重试失效则丢失数据。](#mtpo-1710253936214)

<a name="ohbp-1739985401761"></a>[.弱隔离级别](#jngf-1710167840980)

<a name="r2nh-1739985401763"></a>[安全并行parallel：事务不触及相同数据](#wdhp-1710263089880)

<a name="bs96-1739985401765"></a>[竞争条件：](#ykgs-1710263216103)

<a name="ckhl-1739985401767"></a>[读：事务读取另一个事务同时修改的数据](#er05-1710263177909)

<a name="xa7o-1739985401769"></a>[写：事务同时修改相同的数据](#pypw-1710263203957)

<a name="c4cm-1739985401771"></a>[事务隔离：](#xps5-1710263234506)

<a name="olga-1739985401773"></a>[可序列化(一次一个执行，没有任何并发)](#ghkk-1710263260640)

<a name="psfj-1739985401775"></a>[性能损失](#a876-1710263299289)

<a name="kdkz-1739985401777"></a>[弱隔离级别(非串行化nonserializable)](#nqm3-1710263313752)

<a name="rqel-1739985401779"></a>[较弱的隔离级别防止一部分，而非全部的并发问题](#e7nl-1710263334073)

<a name="1ssn-1739985401781"></a>[资金损失，耗费财务调查，财务数据请使用ACID数据库(注意：流行的数据库也使用弱隔离级别，不一定能防止并发错误)](#2xxd-1710331395046)

<a name="zsak-1739985401783"></a>[读已提交](#pjqb-1710171742279)

<a name="dmzi-1739985401785"></a>[没有脏读](#7h42-1710171796899)

<a name="qqes-1739985401787"></a>[dirty reads：事务看到另一个事务未提交的值](#lyju-1710332135761)

<a name="vgky-1739985401789"></a>[为什么要防止dirty reads：](#x8ch-1710333899846)

<a name="j4ch-1739985401791"></a>[更新多对象：脏读以为只看到部分数据](#pwpa-1710333902582)

<a name="57hk-1739985401793"></a>[事务中止：回滚后，看到的是未提交的数据](#jcj0-1710333902583)

<a name="mx6i-1739985401795"></a>[解决：只能读取提交后的数据，且不会阻塞，并行时保存已提交的旧值 -mvcc](#3mi1-1710332238978)

<a name="xmlu-1739985401797"></a>[没有脏写](#vmfl-1710171803833)

<a name="qojc-1739985401799"></a>[dirty write: 事务同时更新相同对象。后面的写入覆盖尚未提交的值。](#hvah-1710332040048)

<a name="zsg9-1739985401801"></a>[避免的问题：](#chr0-1710333916523)

<a name="szfo-1739985401803"></a>[混乱写入，导致bob后买车先更新发票commit而alic先买车后更新发票commit(buyer=bob but recipient=alice)](#14wx-1710333919188)

<a name="cy50-1739985401805"></a>[解决：延迟/阻塞第二次的写入，直到第一次写入事务提交或终止。](#g1sw-1710332222649)

<a name="knwc-1739985401807"></a>[但不能防止计数器增量的竞争状态。(读写非原子性，写依赖读的副本)](#ujzx-1710333397576)

<a name="j1hv-1739985401809"></a>[计数器增量安全：防止更新丢失 -版本号](#ugiq-1710333641028)

<a name="8x13-1739985401811"></a>[实现读已提交](#z96g-1710171821987)

<a name="2nfl-1739985401813"></a>[默认的隔离级别：oracle,postgreSQL,sql server ,memSql](#tays-1710333754461)

<a name="h6ko-1739985401815"></a>[行锁row-level lock](#svaf-1710333809593)

<a name="e04x-1739985401817"></a>[读写锁防止脏读：读写锁互斥，只有读锁拥有者可持有写锁。](#fsbu-1710334081090)

<a name="cgxf-1739985401819"></a>[缺点：阻塞，性能损失。](#xj1j-1710334321006)

<a name="wgkc-1739985401821"></a>[优化：所以一般用mvcc的模式。-或者copy on write](#7klj-1710334353854)

<a name="7arg-1739985401823"></a>[快照隔离和可重复读](#bww4-1710171760070)

<a name="fefe-1739985401825"></a>[不可重复读nonrepeatable read/读取偏差read skew](#wjut-1710343195467)

<a name="55ta-1739985401827"></a>[skew重载：在热点指的是不平衡，这里指异常时机  alice两个账号各500，alice先读acount1=500,转账员将acount1+100,acount2-100后commit，alice读acount2=400.commit.导致Alice看起来少了100。-暂时不一致。](#jmuu-1710343248537)

<a name="sxj1-1739985401829"></a>[提交后，刷新网页即可。有些情况不能容忍暂时不一致：](#gwgf-1710343469620)

<a name="ko7z-1739985401831"></a>[备份：数据库备份需要几小时，期间接收写入包含新老数据。如果备份用于恢复，不一致就变成永久的了。-解决：全局锁/快照备份](#m0km-1710345572560)

<a name="ts8i-1739985401833"></a>[分析查询和完整性检查：扫描大部分数据库，查询在不同时间点观察数据库产生不同，可能返回无意义的结果。](#i5pt-1710345666724)

<a name="m7hj-1739985401835"></a>[ 快照隔离snapshot isolation 对长时间运行的只读查询非常有用（备份和分析）。](#p7tm-1710345899708)

<a name="ouub-1739985401837"></a>[ 即 一致快照consistent snapshot,即使被另一个事务更改，每个事务只能看到该特定时间的旧数据（特定时间点冻结的一致快照）。](#q8oz-1710345935366)

<a name="kbql-1739985401839"></a>[PostgerSQL, mysql innoDB, Oracle, sqlServer](#mo1i-1710346175801)

<a name="khsp-1739985401841"></a>[实现快照隔离](#2hpt-1710171981487)

<a name="whxl-1739985401843"></a>[关键原则：读不阻塞写，写不阻塞读。两者没有任何锁定争用。](#49s0-1710346236063)

<a name="pgst-1739985401845"></a>[多版本并发控制mvcc,multi-version concurrentcy contorl](#w8v8-1710346319154)

<a name="ts7o-1739985401847"></a>[读已提交不提供快照隔离，保留对象的一两个版本就足够。通常支持快照隔离也是用mvcc来实现读已提交隔离级别：](#fh82-1710346453757)

<a name="0qc2-1739985401849"></a>[读已提交为每个查询使用单独的快照-每个select单独生成。](#3xbw-1710346540026)

<a name="q6ly-1739985401851"></a>[快照隔离对整个事务使用相同的快照-复用第一个select生成的快照](#xqhm-1710346554737)

<a name="8o76-1739985401853"></a>[update操作在内部翻译为Delete 和 insert](#pmk8-1710351883488)

<a name="epej-1739985401855"></a>[-innoDB实际上delete将旧数据版本移到undolog版本链中。垃圾收集会删除任何事务不可见的就对象版本。](#vnfd-1710351911457)

<a name="mlay-1739985401857"></a>[观察一致性快照的可见性规则](#box0-1710171988275)

<a name="b2u5-1739985401859"></a>[从来不更新值，而是每次值改变时创建一个新版本。使得数据库提供一致快照产生的开销很小。](#yapf-1710408915465)

<a name="k7ja-1739985401861"></a>[事务id决定它可以看到哪些对象，规则如下：](#ecrk-1710408160769)

<a name="ddia-1739985401863"></a>[事务开始时列出当时所有事务清单，即使之后提交，这些事务的写入也都会被忽略。](#ogtp-1710408539120)

<a name="uoay-1739985401865"></a>[忽略被中止事务任何写入](#unjc-1710408595672)

<a name="y4zw-1739985401867"></a>[较晚(当前事务之后开始)的写入都被忽略，不管是否提交](#ofbz-1710408626209)

<a name="b1wd-1739985401869"></a>[所有其他写入，对应用都是可见的。](#hgwi-1710408682423)

<a name="f8ff-1739985401871"></a>[对象可见的两条规则](#rg1c-1710408738736)

<a name="50va-1739985401873"></a>[读事务开始时，创建该对象的事务已提交。](#weyp-1710408754844)

<a name="wyci-1739985401875"></a>[请求删除的事务在读事务开始时未提交。](#xqky-1710408773006)

<a name="q9j1-1739985401877"></a>[索引和快照隔离(索引如何在多版本数据库中工作)](#ai77-1710171999516)

<a name="iuiq-1739985401879"></a>[同一对象不同版本放在同一个页面中，PostgreSQL的优化可以避免更新索引](#kanl-1710410047690)

<a name="8d2g-1739985401881"></a>[仅追加/写时拷贝apeend-only/copy-on-wirte的变体B树：更新不覆盖树的页面，为每个修改页创建副本。](#yv2q-1710410120895)

<a name="p06h-1739985401883"></a>[每个写入事务/一批事务都会创建一个新的B树，当创建时，从该特定树根生长的树就是数据库的一个一致性快照。](#etza-1710410471666)

<a name="avfe-1739985401885"></a>[需要负责压缩和垃圾收集的后台进程。](#79xv-1710410561061)

<a name="j6kr-1739985401887"></a>[可重复读与命名混淆](#xr4f-1710172004472)

<a name="yrxz-1739985401889"></a>[原因：System R定义隔离级别时并未有快照隔离](#nohd-1710417835613)

<a name="tgqm-1739985401891"></a>[oracle DB2 称为序列化](#uwdp-1710417928621)

<a name="ufxc-1739985401893"></a>[postgreSql mySql称为可重复读](#f5te-1710417946615)

<a name="dhgz-1739985401895"></a>[防止丢失更新](#e9wg-1710171770800)

<a name="zl2s-1739985401897"></a>[脏写导致丢失更新lost update](#ajmt-1710418075399)

<a name="j9m0-1739985401899"></a>[读取-修改-写入序列的狠揍clobber：第二个事务并没有包括第一个事务的修改: -写依赖读](#c7rv-1710418271703)

<a name="fuoo-1739985401901"></a>[增加计数器或更新账户余额(需读取当前值，计算新值并写回更新后的值)](#uvoq-1710418375497)

<a name="tcsu-1739985401903"></a>[进行本地修改： 解析文档，更改后回写修改的文档](#ro12-1710418458493)

<a name="gr2j-1739985401905"></a>[同时编辑wiki页面：整个页面覆盖当前内容。](#9n83-1710418515773)

<a name="funx-1739985401907"></a>[原子写(x排它锁)](#lftw-1710172034957)

<a name="f4lr-1739985401909"></a>[数据库原子更新操作保证并发安全](#6jim-1710418574114)

<a name="rg1r-1739985401911"></a>[mysql: 行级写锁](#dxgy-1710419672127)

<a name="qqgy-1739985401913"></a>[MongoDB：对JSON文档一部分进行本地修改的原子操作](#bqxj-1710419591972)

<a name="ydks-1739985401915"></a>[redis提供了优先队列等修改数据的原子操作。](#wxju-1710419646040)

<a name="0va4-1739985401917"></a>[原子操作/游标稳定性cursor stability：通常在读取对象时获取其上的排它锁，以便提交前没有事务可以读取它。另一个选择是将所有原子操作在单一线程上执行。-redis](#h0ip-1710421887552)

<a name="podk-1739985401919"></a>[unfortunately,ORM框架易执行读取-修改-写入序列，而不是使用数据库提供的原子操作。如果你知道自己在做什么那当然不是问题](#6hwo-1710422121598)

<a name="xtub-1739985401921"></a>[显式锁定(for update：读-改-写序列)](#vysa-1710172041914)

<a name="yb8b-1739985401923"></a>[让应用程序显示锁定更新的对象，直到一个读取-修改-写入序列完成](#oknq-1710422501689)

<a name="yxcw-1739985401925"></a>[select ..... for update;](#89ij-1710422624973)

<a name="cwqf-1739985401927"></a>[--更新先前select 返回棋子的位置。](#50q1-1710422845671)

<a name="xzke-1739985401929"></a>[ update](#rmgw-1710422637550)

<a name="ep3c-1739985401931"></a>[for update-对返回的所有行加锁，忘记加锁很容易引入竞争条件(同时修改)](#euv5-1710422671170)

<a name="mp7m-1739985401933"></a>[自动检测丢失的更新(管理器检测处理并发问题)](#jpu5-1710172058032)

<a name="1tow-1739985401935"></a>[允许并行执行，事务管理器检测到丢失更新，中止事务并强制重试读-改-写序列。](#8ytj-1710423161566)

<a name="memc-1739985401937"></a>[Oracle可串行化(快照隔离)和sqlServer的快照隔离级别会自动检测到丢失更新，中止惹麻烦的事务。一些作者认为能防止丢失更新才算提供快照隔离。这个定义下，mysql不算提供快照隔离](#w9el-1710423029153)

<a name="dpgv-1739985401939"></a>[优点：是一个很好的功能，不需要应用代码使用任何特殊数据库功能。允许你忘记加锁或原子操作，由管理器检测丢失更新。](#qg6e-1710423330067)

<a name="cnjh-1739985401941"></a>[比较并设置(CAS)](#ftwe-1710172063360)

<a name="00er-1739985401943"></a>[不提供事务的数据库中的原子操作：比较并设置（CAS compare and set）](#os3h-1710424617661)

<a name="utvo-1739985401945"></a>[update table set content='new content' where id=123 and content = 'old content'  必要时重试](#hlfh-1710425612756)

<a name="2nwt-1739985401947"></a>[问题：数据库允许where子句从旧快照读取，此语句无法防止丢失更新。即另一个并发写入，where条件也为真。-非当前读或非原子写。](#rxcv-1710425806449)

<a name="tbxf-1739985401949"></a>[解决：检查数据库的CAS是否安全。保证比较交换为当前读且写是否加锁/原子写](#zss4-1710425865867)

<a name="1zyv-1739985401951"></a>[冲突解决与复制(多个数据库副本的并发)](#bvrp-1710172079412)

<a name="hmf5-1739985401953"></a>[基于锁和cas操作不适用于多个数据库副本](#ewf7-1710434904534)

<a name="qez3-1739985401955"></a>[如检测并发写入：允许并发吸入创建多个冲突版本(也称兄弟），应用代码或特殊数据结构在发生之后解决合并这些版本。](#8dx4-1710434970886)

<a name="geed-1739985401957"></a>[原子操作可在复制的上下文中很好工作，尤其具有可交换性时。Riak2.0不同客户端同时更新一个值是，Riak将自动更新合并在一起，以免丢失更新。防止复制副本丢失更新。](#gl8j-1710435048968)

<a name="hdxs-1739985401959"></a>[最后写入LWW解决冲突很容易丢失更新。unfortunately,许多复制数据库默认LWW。](#gdtn-1710435259414)

<a name="9c0v-1739985401961"></a>[写入偏差与幻读（两个事务更新两个不同的对象）](#rkev-1710172453385)

<a name="i6un-1739985401963"></a>[select count(*) where oncall=true....alice 和 bob分别查在职医生人数](#itfd-1710436127298)

<a name="rp4a-1739985401965"></a>[update...set oncall=false 然后将自己的记录更新为请假，违反至少一医生在职。](#leam-1710436160580)

<a name="lczh-1739985401967"></a>[写偏差的特征](#ovid-1710172462835)

<a name="mzuc-1739985401969"></a>[特征：涉及多个对象，单对象的原子操作不起作用](#iedp-1710437034438)

<a name="4pj1-1739985401971"></a>[快照隔离实现中，自动检测丢失更新对此无帮助。postgred,innodb的可重复读，oracle序列化或sql server的快照隔离级别中，都不会自动检测写入偏差。写入偏差需要真正的可序列隔离-业务上的问题。](#wszw-1710437034814)

<a name="hnmn-1739985401974"></a>[数据库配置约束，指定至少一个值为true.大多数不支持这种配置，可以使用触发器或者物化视图实现。](#hn04-1710437034815)

<a name="p5e4-1739985401976"></a>[显示锁定。 select ...fro update -锁定返回的所有行，锁定两个医生（行锁+间隙锁）](#crrt-1710437034816)

<a name="xkin-1739985401978"></a>[写偏差的更多例子](#4jr1-1710172470885)

<a name="4xya-1739985401980"></a>[读数据为空，分别插入一条数据的会议室预定系统：select count(*) from bookings where roomid=123 and time...，insert into bookings....不能防止另一个用户插入冲突会议。解决：又需要串行化执行。](#0hyt-1710437389755)

<a name="qjtc-1739985401982"></a>[多人游戏：棋盘用锁防止丢失更新，但锁定不能妨碍将不同的棋子放在相同位置。产生写入偏差 。解决：使用唯一约束。](#pgcb-1710437636980)

<a name="vemk-1739985401984"></a>[抢注用户名：和会议系统一样。不过唯一性约束可以解决该问题。](#bwel-1710437042998)

<a name="oyod-1739985401986"></a>[防止双重开支；用户花钱和积分服务，检查支付数不超过余额，有了写入偏差，可能会发生两个支出项目同时插入，导致余额变为负值，两个事务都不会注意到另一个。](#ogt8-1710438166946)

<a name="vzkj-1739985401988"></a>[导致写入偏差的幻读](#8gty-1710172478550)

<a name="oker-1739985401992"></a>[所有以上例子都遵循类似的模式](#tw0y-1710438423955)

<a name="uysy-1739985401994"></a>[Select查询符合条件的行，至少两名医生值班；不存在该会议室同一时段的预定；棋盘位置未被占据；用户未被抢注；账户还有足够余额](#bngi-1710438445792)

<a name="u1mq-1739985401996"></a>[按照第一个查询的结果，应用代码决定是否继续](#l6p0-1710438590471)

<a name="eef6-1739985401998"></a>[应用决定继续操作，执行写入(插入更新删除），并提交事务](#qt10-1710438739456)

<a name="gq1a-1739985402000"></a>[步骤3修改的行，是步骤1中返回的行之一，可以使用select for update来使事务安全避免写入偏差.](#cdmo-1710438899441)

<a name="aw89-1739985402002"></a>[但检查是否不存在满足条件行，写入添加一个匹配相同条件的行。如果步骤1中的查询没有返回任何](#caet-1710439501945)

<a name="e4ie-1739985402004"></a>[⾏，则 SELECT FOR UPDATE 锁不了任何东⻄（读已提交） 。PS:innodb可重复读读null数据会加间隙锁，不走索引则锁表。](#bsm5-1739288894816)

<a name="i7h4-1739985402006"></a>[       这种效应：一个事务中的写入改变另一个事务的搜索查询结果，被称为幻读。快照隔离避免了只读查询中的幻读。以上的读写事务中，幻影会导致特别棘手的写歪斜情况。](#cwgh-1710440241091)

<a name="gwkm-1739985402008"></a>[物化冲突](#1cjy-1710172485201)

<a name="lax4-1739985402010"></a>[物化冲突：将幻读变为数据库中一组具体行上的锁冲突。](#fv3x-1710440426895)

<a name="r1f4-1739985402012"></a>[通过创建时间槽和房间的表，提前出入房间和时间的所有可能组合。创建预定的事务可以select for update锁定房间和时间段对应的行，在获得锁定后，可以检查重叠的预定并插入新的预定。该表不是存储预定相关的信息，它完全就是一组锁，用于防止同时修改同一房间和时间范围内的预定。](#laff-1710440634993)

<a name="jpbe-1739985402014"></a>[缺点：弄清除如何物化冲突可能很难，也很容易出错，而让并发控制机制泄露到应用数据模型是很丑陋的做法。](#dngy-1710441936216)

<a name="8i0n-1739985402016"></a>[物化冲突应为最后的手段。可序列化Serializeble级别是更可取的。](#i0he-1710441997817)

<a name="dwwy-1739985402018"></a>[.可序列化](#di29-1710167844061)

<a name="qq0i-1739985402020"></a>[弱隔离级别读已提交和快照隔离不能解决写入偏差幻读：](#ztac-1710587737356)

<a name="cbbr-1739985402022"></a>[隔离级别难以理解，且不同数据库中实现不一致，可重复读概念不一样](#ky3h-1710588699885)

<a name="y6ev-1739985402024"></a>[光检查应用代码很难判定在特定隔离界别是否安全](#tpbs-1710588738858)

<a name="z4yq-1739985402026"></a>[无检测竞争条件的好工具，往往倒霉时才会出现问题。](#jp98-1710588779920)

<a name="dw86-1739985402028"></a>[20世纪70年代system R就已经是这样，研究人员的答案都很简单：可序列化（serializeble）级别（但非人见人爱），都使用三种技术之一。](#sqvc-1710588820273)

<a name="dl9q-1739985402030"></a>[字面意义上的串行顺序执行事务](#mqa4-1710589545518)

<a name="opms-1739985402032"></a>[两相锁定2PL two-phase locking,几十年来唯一的可行选择](#neot-1710589568078)

<a name="dxku-1739985402034"></a>[乐观并发控制，可序列话的快照隔离serializable snapshot isolation](#pizj-1710589721553)

<a name="rg1c-1739985402036"></a>[真的串行执行(单线程执行事务)](#2oi3-1710172506817)

<a name="pkc9-1739985402038"></a>[数据库设计人员07年才确定，单线程循环执行事务时可行的。（多线程过去30年中被认为是获得良好性能的关键所在）](#o5af-1710589822067)

<a name="afbw-1739985402040"></a>[两个进展引发了这个反思：](#phuh-1710609564138)

<a name="8pq7-1739985402042"></a>[RAM足够便宜，许多场景可以将完整的活跃数据保存在内存中。-redis](#owi7-1710609747624)

<a name="faru-1739985402044"></a>[数据库设计人员意识到OLTP事务很短，只进行少量的读写操作。长时间的分析查询通常是只读的，可以用一致快照（快照隔离）上运行。](#vhy4-1710609817752)

<a name="lpzx-1739985402046"></a>[VoltDB/H-Store, Redis 和 Datomic中实现。避免锁的协调开销。吞吐量仅限单个cpu](#xcax-1710609934885)

<a name="rei2-1739985402048"></a>[在存储过程中封装事务(优化交互式单线程事务)](#xh4n-1710172519134)

<a name="vvc2-1739985402050"></a>[数据库设计者认为，机票全流程是一个事务，可以被原子化执行。缺点：交互式会使流程性能直接下降。](#xthc-1710757083497)

<a name="zgba-1739985402052"></a>[解决：单线程串行执行事务的系统不允许交互式的多语句事务。提前将整个事务作为存储过程提交数据库：](#oo8b-1710757291600)

<a name="sicr-1739985402054"></a>[Interactive transaction :bob医生请假 1.select count  2.if count>=2 3.update false](#9fzd-1710757436562)

<a name="ycw4-1739985402056"></a>[stored procedure: execute stored take doctor of call](#gegl-1710763202697)

<a name="spgz-1739985402058"></a>[事务所需的数据都在内存中，快速执行，无需等待网络和磁盘IO](#t47s-1710763179337)

<a name="eonk-1739985402060"></a>[存储过程的优点和缺点](#7ksv-1710172529258)

<a name="rsom-1739985402062"></a>[名声不好：](#jfoa-1710763413471)

<a name="zaau-1739985402064"></a>[陈旧丑陋无库生态，数据库存储过程各自的语言没跟上通用编程语言的发展](#4qhf-1710763421594)

<a name="szq8-1739985402066"></a>[管理困难，调试困难，版本控制测试部署困难，和监控指标的系统集成困难](#96la-1710763483936)

<a name="n0tm-1739985402068"></a>[单个数据库通常由多个应用共享，写得不好的存储过程（占用大量内存和cpu）会比代码造成更大麻烦](#idii-1710763602399)

<a name="o5lx-1739985402070"></a>[ 这些问题都可以克服。现代存储过程放弃了PL/SQL,使用现有通用编程语言：VoltDB使用java或Groovy, Datomic使用Java或Clojure, Redis使用Lua.](#1w0a-1710763899035)

<a name="os7p-1739985402072"></a>[存储过程与内存存储，使得单线程执行事务可行，](#bp68-1710767504595)

<a name="oolg-1739985402074"></a>[无需等待I/O,](#ahfz-1710767568244)

<a name="rk1d-1739985402076"></a>[避免并发控制机制的开销，可以在单线程实现相当好吞吐量](#mfvt-1710767570930)

<a name="ufom-1739985402078"></a>[VoltDB还用存储过程进行复制，在每个节点上执行相同的存储过程，所以要求存储过程是确定性的。比如使用当前日期，需要通过特殊的确定性API实现。](#7m1p-1710767621202)

<a name="qtn0-1739985402080"></a>[分区](#xxtp-1710172539181)

<a name="zq2s-1739985402082"></a>[顺序执行事务使并发控制简单多，但吞吐限制为单机单核。吞吐量高的应用，单线程将可能成为严重瓶颈。](#rqu5-1710767939361)

<a name="hudw-1739985402084"></a>[扩展多核多节点，可以对数据进行分区，每个事务只需在单个分区中读写数据，事务吞度量就可以与cpu保持现行扩展。](#puih-1710768082742)

<a name="lkgr-1739985402086"></a>[对于需要访问多个分区的任务事务，需要进行协调，存储过程跨所有分区锁定执行，保证串行。](#jpiw-1710768164695)

<a name="5bdc-1739985402088"></a>[缺点：协调开销性能比单区事务慢得多。VoltDB吞吐量每秒1000个跨分区写入，比单分区低几个数量级，且通过增加机器来提高](#fgu3-1710768218238)

<a name="smqb-1739985402090"></a>[事务是否可划分-应用的数据结构，键值数据，多个二级索的数据引需要大量跨分区协调。](#8lf4-1710768407791)

<a name="y58z-1739985402092"></a>[串行执行小结](#zyih-1710172540516)

<a name="aokq-1739985402094"></a>[需每个事务小而快，一个缓慢的事务拖慢所有事务。](#dibg-1710768638498)

<a name="zlbc-1739985402096"></a>[可放入内存仅限活跃数据集，少量数据会移动到磁盘。但需要访问执行中的事务，系统会变慢。](#22nq-1710768681244)

<a name="atsr-1739985402098"></a>[写入吞吐量必须低到能在单个cpu运行，否则事务能划分至但分区，且无需分区协调](#jmsk-1710768781527)

<a name="wkcl-1739985402100"></a>[跨分区事务使用程度受限。](#wlnd-1710769060180)

<a name="ggfj-1739985402102"></a>[两阶段锁定（2PL）](#uhxa-1710172558745)

<a name="vrir-1739985402104"></a>[30年高使用的序列化算法：两阶段锁定2PL two phase locking ,独占访问exclusive access:](#nhdj-1710769248115)

<a name="nfy6-1739985402106"></a>[事务A读取对象，阻塞B写入，直至A提交；](#khdp-1710769659952)

<a name="1xgm-1739985402108"></a>[事务A写入对象，阻塞B读取,直至A提交；](#elpw-1710769685611)

<a name="8zlp-1739985402110"></a>[快照隔离使得不会阻塞读，2PL提高序列化性质，解决丢失更新和写入偏差。](#6ja2-1710769959539)

<a name="4xbc-1739985402112"></a>[实现两阶段锁](#lfuv-1710172605096)

<a name="h0hx-1739985402114"></a>[2PL即innoDB可序列化级别及DB2可重复读隔离级别。](#8oif-1710770052594)

<a name="emsr-1739985402116"></a>[读写阻塞为每个对象添加锁。共享模式shared mode 与独占模式exclusive mode:](#6wad-1710770158675)

<a name="nnth-1739985402118"></a>[读取对象需以共享模式获取锁。读共享](#1dyc-1710770195788)

<a name="zfat-1739985402120"></a>[写入需独占模式取锁。写互斥。](#bshw-1710770251530)

<a name="c78j-1739985402122"></a>[事务获得锁必须持有锁知道事务结束(提交或中止)。即一阶段获取锁，二阶段释放所有锁。](#r0b0-1711207524774)

<a name="ytef-1739985402124"></a>[死锁deadlock, 数据库会自动检测死锁，并中止其中一个。被中止的事务充实需应用程序实现。](#iuyh-1710770211133)

<a name="4baq-1739985402126"></a>[两阶段锁定的性能](#qi7j-1710172616303)

<a name="hy6g-1739985402128"></a>[比弱隔离差得多](#vz0p-1711207837446)

<a name="2ixv-1739985402130"></a>[锁开销、串行并发性降低](#ienx-1711207878742)

<a name="vrev-1739985402132"></a>[交互式事务形成等待队列、高百分位响应慢](#z85f-1711207913718)

<a name="gb7d-1739985402134"></a>[死锁频繁时重试造成浪费](#kmkr-1711207799940)

<a name="iz2k-1739985402136"></a>[谓词锁predicate lock](#ccq8-1710172621528)

<a name="kevf-1739985402138"></a>[谓词锁：属于符合搜索条件的对象，解决幻读phantoms](#kfpi-1711208306292)

<a name="yvqy-1739985402140"></a>[事务A获取共享谓词锁shared-mode predicate lock读取匹配对象，与排它互斥](#6dqd-1711208459688)

<a name="mawv-1739985402142"></a>[事务A写入需等待其他事务谓词锁释放。](#p3er-1711208588906)

<a name="3aij-1739985402144"></a>[适用于尚不存在，将可能添加的对象（幻象），如果两阶段包含谓词锁，可实现串行化。](#bdwj-1711208433268)

<a name="y1kb-1739985402146"></a>[索引范围锁next-key lock](#zv5c-1710172626404)

<a name="vprx-1739985402148"></a>[谓词锁性能不佳：活跃事务持锁多，检查匹配非常耗时](#a3ce-1711208973949)

<a name="p8av-1739985402150"></a>[2PL采用索引范围锁-简化版谓词锁：](#ayfb-1711209059199)

<a name="lbfe-1739985402152"></a>[索引位于roomid, 指示room123用于预定](#qmbu-1711212311152)

<a name="fnaw-1739985402154"></a>[或者索引位于时间上，指示12:00~13:00用于预定。](#ajbo-1711212362665)

<a name="f84k-1739985402156"></a>[以上任何一条件，当另一个事务想写入时，需要更新索引-叶子节点，会收到共享锁。解决幻读和写入偏差](#k1ie-1711212755816)

<a name="apnv-1739985402158"></a>[索引范围锁不如谓词锁精确，但开销低](#6lzs-1711212829915)

<a name="8goc-1739985402160"></a>[无可挂载索引，将退化为表锁，性能不利，但这是回退到一个安全位置。](#bofb-1711212877091)

<a name="fmuz-1739985402162"></a>[序列化快照隔离SSI（高性能序列化算法）](#slwa-1710172573367)

<a name="bhnf-1739985402164"></a>[新算法：可序列化快照隔离SSI serializeble snapshot isolation 仅与快照隔离有很小性能损失. 08年 micheal cahill博士论文。](#lnci-1711213123166)

<a name="q3f6-1739985402166"></a>[用于单节点PostgreSQL9.1后序列化和分布式数据库](#weo0-1711213307841)

<a name="o2te-1739985402168"></a>[处于实践证明阶段](#ue1s-1711213377985)

<a name="xjav-1739985402170"></a>[悲观pessimistic与乐观optimistic的并发控制](#yq9i-1710172639651)

<a name="bbum-1739985402172"></a>[极致悲观：串行排它锁](#54jr-1711213690005)

<a name="wn1u-1739985402174"></a>[序列化快照隔离SSI是乐观技术： ](#bjxf-1711213769533)

<a name="yy36-1739985402176"></a>[缺点：多事务争用contention时性能不佳，大部分事务中止，吞吐量极限下有重试机制将使性能变差。](#mefw-1711213819265)

<a name="6lkt-1739985402178"></a>[优点：有备用容量，竞争不高场景比悲观好，可交换的原子操作可减少争用。](#nk1s-1711213915330)

<a name="hln7-1739985402180"></a>[SSI在快照隔离基础上添加算法检测写入的序列化冲突，并决定中止哪些事务。](#snvf-1711214019984)

<a name="yzh0-1739985402182"></a>[基于过时前提的决策](#9lgw-1710172651041)

<a name="mmzt-1739985402184"></a>[医生值班读取-修改-写入。数据库检测过时并终止：](#td4m-1711214184809)

<a name="btuj-1739985402186"></a>[检测对旧MVCC对象版本的读取(读之前存在未提交的写入)](#t08a-1711215992016)

<a name="mtg7-1739985402188"></a>[检测影响先前读取的写入（读之后发生写入）](#aego-1711216030637)

<a name="dzoj-1739985402190"></a>[检测旧MVCC读取](#5smj-1710172660675)

<a name="wajp-1739985402192"></a>[事务提交时，检测是否有被忽略的写入已被提交。](#z7u2-1711216050316)

<a name="4l9a-1739985402194"></a>[SSI支持一致快照中长时间运行的读取-仅在提交时中止检测的陈旧读取。因为只读不产生幻读和写入偏差风险](#afqq-1711216243096)

<a name="temt-1739985402196"></a>[检测影响之前读取的写入](#mvok-1710172671381)

<a name="ebtg-1739985402198"></a>[事务写入提交时，在索引中查找最近读取受影响的其他事务，通知读取的事务非最新。并中止未提交写入的其他事务。](#mo5j-1711216452745)

<a name="zcek-1739985402200"></a>[可序列化的快照隔离的性能](#0sq6-1710172685702)

<a name="osgv-1739985402202"></a>[粒度granularity，精准哪些事务需要中止，但簿记开销显著。](#g2eg-1711216636788)

<a name="jv0f-1739985402204"></a>[简略的跟踪速度快（粗粒度），但导致不必要的事务中止。](#ux2m-1711216812849)

<a name="xpyl-1739985402206"></a>[相比2PL, 不需要锁定阻塞，读性能高](#jzqb-1711216700614)

<a name="kyaf-1739985402208"></a>[相比串行化，可扩展多台机器提高吞吐量，可跨分区读。](#qm51-1710756953994)

<a name="vufk-1739985402210"></a>[SSI要求事务尽量短，避免长事务发生冲突中止。慢事务SSI比2PL或串行执行更不敏感](#wvsk-1711216911828)

<a name="4ufo-1739985402212"></a>[8.分布式系统的麻烦](#enui-1704985776096)

<a name="1cwx-1739985402214"></a>[前几章failover故障切换, 复制延迟 与事务控制 处理各种可能发生的边缘情况，本章则是彻底的悲观总结。](#e2bp-1711387736669)

<a name="8k33-1739985402216"></a>[故障与部分失效](#4yaw-1711386647072)

<a name="fwhy-1739985402218"></a>[部分失效partial failure  不确定性的nondeterministic: IDC配电单元故障](#9d0g-1711387883443)

<a name="jw3a-1739985402220"></a>[云计算与超级计算机](#w7ln-1711386736921)

<a name="jm4v-1739985402222"></a>[不可靠的网络(Timeout)](#ynhs-1711386665148)

<a name="jdc0-1739985402224"></a>[请求丢失： 拔网线](#fav6-1711388032544)

<a name="jct0-1739985402226"></a>[请求排队：](#znsf-1711388048086)

<a name="7p2w-1739985402228"></a>[请求失效：](#gmdu-1711388084834)

<a name="y1ib-1739985402230"></a>[.....](#dssu-1711388054944)

<a name="6vhr-1739985402232"></a>[真实世界的网络故障](#y933-1711387087536)

<a name="wirh-1739985402234"></a>[检测故障](#aywv-1711387099045)

<a name="ms5v-1739985402236"></a>[超时与无穷的延迟](#z4hi-1711387103669)

<a name="bbis-1739985402238"></a>[级联失效cascading failure](#qs2e-1711388153448)

<a name="ab7v-1739985402240"></a>[网络拥塞和排队](#gttn-1711387323883)

<a name="6elt-1739985402242"></a>[TCP执行流量控制flow control](#v9f2-1711388199023)

<a name="fi3y-1739985402244"></a>[视频、语音会议使用UDP，折中丢包与流畅](#up7k-1711389082773)

<a name="sxng-1739985402246"></a>[同步网络vs异步网络](#t56p-1711387113980)

<a name="5duj-1739985402248"></a>[有限延迟bounded delay：同步网络，不收排队影响](#fmrl-1711389283437)

<a name="cref-1739985402250"></a>[我们不能简单地使用网络延迟可预测吗](#bwvp-1711387335617)

<a name="xza0-1739985402252"></a>[不可靠的时钟](#l3p1-1711386676597)

<a name="mbaq-1739985402254"></a>[机器的时钟：硬件设备，石英振荡器，](#faqp-1711469591901)

<a name="iorb-1739985402256"></a>[不是完全准确的。](#xtjc-1711469629964)

<a name="oxow-1739985402258"></a>[同步时钟：网络时间协议NTP](#knwp-1711469656643)

<a name="rrpp-1739985402260"></a>[服务器从精确时间源获取时间-GPS接收器](#pfpq-1711469689783)

<a name="v8fe-1739985402262"></a>[单调钟与时钟](#qoxv-1711387218692)

<a name="ucgn-1739985402264"></a>[时钟](#wu2k-1711387376627)

<a name="wpsp-1739985402266"></a>[Linux: clock_gettime(CLOCK_REALTIME)](#obwb-1711469781129)

<a name="4hqd-1739985402268"></a>[java:system.currentTimeMilis](#uxdp-1711469821742)

<a name="otnz-1739985402270"></a>[通常与NTP同步，但举例NTP服务器太远，则可能被强制重置(及时跳回）](#gwyx-1711469840905)

<a name="spds-1739985402272"></a>[单调钟](#hl1a-1711387385739)

<a name="ij6r-1739985402274"></a>[保证总是前进](#uzaz-1711470052827)

<a name="w3bo-1739985402276"></a>[Linux:CLOCK_MONOTONIC](#tbmn-1711469988760)

<a name="2ot4-1739985402278"></a>[java:System.nanoTime](#fb70-1711470014393)

<a name="5njm-1739985402280"></a>[调整频率：NTP检测到计算机石英钟更快或更慢，则调整单调钟频率（偏移skewing时钟）.](#sn42-1711470028035)

<a name="qgpu-1739985402282"></a>[不假定不同节点时钟存在同步：分布式系统用单调钟效果好，对测量的不准确不敏感](#ct3v-1711470667953)

<a name="jtab-1739985402284"></a>[时钟同步与准确性](#a7gy-1711387238026)

<a name="ob4t-1739985402286"></a>[漂移drifts: 计算机石英钟不准确原因,取决机器温度。](#pbyu-1711470750697)

<a name="fiim-1739985402288"></a>[实现精确度：GPS接收机，精确时间协议PTP](#kgdy-1711470917769)

<a name="g0pn-1739985402290"></a>[同步错误的原因：NTP守护进程配置错误，防火墙阻止NTP通信。](#kgez-1711470944635)

<a name="9nzd-1739985402292"></a>[依赖同步时钟](#vo0i-1711387245745)

<a name="uetu-1739985402294"></a>[使用需要同步时钟的软件需监测所有机器间的时钟偏移](#zm2f-1711471000801)

<a name="xbqt-1739985402296"></a>[有序事件的时间戳](#fnxq-1711387475761)

<a name="oitu-1739985402298"></a>[写入排序问题：B客户端写入比A晚但具有更早的时间戳。 ](#n1pp-1711471283186)

<a name="b2aj-1739985402300"></a>[ 最后写入为准LWW](#50kp-1711471399605)

<a name="6xgz-1739985402302"></a>[ 版本向量](#axgx-1711471482711)

<a name="pb38-1739985402304"></a>[时钟读数存在置信区间](#ofpq-1711387431462)

<a name="0yiq-1739985402306"></a>[ 置信区间的不确定性：NTP服务器的不去定性，加上服务器网络往返时间](#aihs-1711471513794)

<a name="r1zk-1739985402308"></a>[当clock_gettime()返回值不会告诉你预期错误，不知道置信区间是5毫秒还是5年](#aave-1711471693187)

<a name="vjqz-1739985402310"></a>[例外：Spanner Google TureTime API明确报告本地时钟置信区间（最早，最晚）。](#znqm-1711471741654)

<a name="ii86-1739985402312"></a>[全局快照的同步时钟](#bfz6-1711387449885)

<a name="exez-1739985402314"></a>[分布式的事务快照隔离，分布式事务ID时序成为站不住脚瓶颈](#dpco-1711471815493)

<a name="p0ee-1739985402316"></a>[Spanner通过置信区间来比较A,B发生的时序。](#2ihe-1711471939317)

<a name="tsth-1739985402318"></a>[分布式事务语义使用时钟同步是一个活跃的研究领域，没有在谷歌之外的主流数据库中实现。](#9qfk-1711471991096)

<a name="noc1-1739985402320"></a>[暂停进程](#3mnj-1711387250438)

<a name="c1yk-1739985402322"></a>[如何确保分布式主节点仍未领导者](#ui0e-1711472636558)

<a name="fahi-1739985402324"></a>[方式一：从其他节点获得租约lease, 类似一个带超时的锁，周期性过期前续约。-和redison续约类似](#yh9a-1711472775035)

<a name="odgw-1739985402326"></a>[过期时，由另一个节点接管。](#kqwv-1711472837428)

<a name="t715-1739985402328"></a>[缺点：依赖同步时钟](#gi5a-1711473874947)

<a name="nvn8-1739985402330"></a>[意外的时间停顿：](#93uw-1711473992955)

<a name="nd2r-1739985402332"></a>[stop-the-world  HotSpot GC](#7kp7-1711474017909)

<a name="exnr-1739985402334"></a>[suspend虚拟机](#6ejp-1711474059672)

<a name="obzn-1739985402336"></a>[随意暂停恢复：关闭笔记本盖子](#92se-1711474080346)

<a name="2hos-1739985402338"></a>[窃取时间steal time:虚拟机切换或cpu上下文切换，在其他机器中花费的时间.](#tfxw-1711474128862)

<a name="wv7m-1739985402340"></a>[同步时的阻塞io：java惰性加载类文件；磁盘为网络文件系统或网络块设备-亚马逊EBS](#7jwg-1711474280466)

<a name="wyhx-1739985402342"></a>[磁盘交换内存抖动thrashing: 允许交换到磁盘（分页），内存访问可能导致页面错误page fault .话费大量时间将页面交换到内存，实际完成的工作很少thrashing。 服务器机器禁用页面调度，干掉进程释放内存。](#kvsa-1711474441136)

<a name="eayt-1739985402344"></a>[SIGSTOP暂停unix进程:Ctrl-Z立即阻止进程的CPU周期](#ocvk-1711474648160)

<a name="epqu-1739985402346"></a>[这些都可以随时抢占preempt正在运行的线程。](#t1w7-1711474768157)

<a name="54cy-1739985402349"></a>[响应时间保证](#cirf-1711473855327)

<a name="wj5s-1739985402351"></a>[硬实时hard real-time系统: 不满足特定截止时间deadline可能会导致整个系统故障。](#r1ji-1711474887529)

<a name="67eg-1739985402353"></a>[嵌入式系统精心设计和测试：安全气囊不会因系统GC暂停弹出。](#pgjw-1711475001376)

<a name="lerq-1739985402355"></a>[大量的额外工作，昂贵。](#urp5-1711475089330)

<a name="4aph-1739985402357"></a>[限制垃圾收集的影响](#i1wt-1711387521748)

<a name="pxeq-1739985402359"></a>[通知GC暂停，停止接收新请求-对延迟敏感的金融系统](#oxal-1711475134772)

<a name="ouzh-1739985402361"></a>[变种：GC只收集新生代，积累老年代，一次重启一个节点，类似滚动升级。](#ho3v-1711475217820)

<a name="bgpl-1739985402363"></a>[知识、真相与谎言](#ujyf-1711386681865)

<a name="nmyd-1739985402365"></a>[真理由多数所定义](#hdwi-1711387268312)

<a name="srpq-1739985402367"></a>[stop the world 一分钟，被其他节点宣告死亡，重新选举。](#rxcy-1711561420884)

<a name="xdsx-1739985402369"></a>[领导者与锁定](#3zea-1711387542106)

<a name="1baw-1739985402371"></a>[数据库分区领导者只能有一个节点：避免脑裂](#b6am-1711561462773)

<a name="8guv-1739985402373"></a>[特定资源的锁和对象只允许一个事务/客户端持有](#3ynw-1711561525662)

<a name="352w-1739985402375"></a>[用户唯一标识](#hqa3-1711561556083)

<a name="xtrf-1739985402377"></a>[节点认为它是天选者the choosen one](#rv2w-1711561875596)

<a name="psx0-1739985402379"></a>[HBase例子：分布式锁的实现不正确，客户端1持有锁stop the world导致lease超时,客户端2获得锁进行处理，客户端1仍认为它具有有效的租约，即使它已经过期，从而破坏了存储的文件。](#gu25-1711561617808)

<a name="awng-1739985402381"></a>[防护令牌](#mhlf-1711387550649)

<a name="x6bf-1739985402383"></a>[解决天选者问题：防护fencing](#gw5w-1711561950975)

<a name="tiax-1739985402385"></a>[fencing token :只允许增加屏蔽令牌的顺序进行写操作。](#vi5w-1711562021406)

<a name="4lie-1739985402387"></a>[服务器端检查token,获取锁时token增加33+1，存储服务器记录更高令牌34的写入，拒绝令牌33的请求。-一般是redisson续期，这个更像乐观锁。](#2yxl-1711562140276)

<a name="ifrp-1739985402389"></a>[ZooKeeper将事务标识zxid和节点版本conersion用作屏蔽令牌。保证了单调递增](#e6n2-1711562077138)

<a name="vwtt-1739985402391"></a>[如文件存储服务器可将令牌卸载文件命中](#uujk-1711564755459)

<a name="qiwl-1739985402393"></a>[拜占庭故障](#bsay-1711387279845)

<a name="lkzu-1739985402395"></a>[拜占庭故障Byzantine fault: 在不信任的环境中达成共识的问题称为拜占庭将军问题。](#id0b-1711628556885)

<a name="apac-1739985402397"></a>[拜占庭将军问题：n位将军需要同意，一些叛徒通过发送虚假或不真实信息来混淆欺骗他人。](#lxw6-1711628612728)

<a name="na9f-1739985402399"></a>[拜占庭容错：系统在部分节点发生故障、不遵守协议，恶意攻击，扰乱网络时仍能继续正确工作：](#lpn6-1711628716132)

<a name="fczq-1739985402401"></a>[航空航天环境计算机被辐射破坏，不可预知方式响应其他节点](#py6z-1711638469892)

<a name="wk8i-1739985402403"></a>[多个参与组织系统中，参与者试图欺骗他人。比特币等区块链对等网络让互不信任的各方同意交易不依赖中央当局。](#csli-1711638605446)

<a name="upks-1739985402405"></a>[弱谎言形式](#f38o-1711387557457)

<a name="jnak-1739985402407"></a>[添加防止撒谎弱形式机制；](#eepx-1711638744038)

<a name="pf9y-1739985402409"></a>[校验和防止数据包被破坏](#yseh-1711638821915)

<a name="xqm7-1739985402411"></a>[公开访问的系统需仔细清理来自用户的任何输入](#2a8h-1711638847924)

<a name="5gjs-1739985402413"></a>[NTP多数对时间范围达成一致，配置错误的服务器将被排除](#zcdt-1711638888096)

<a name="tdpr-1739985402415"></a>[系统模型与实现](#x4lu-1711387293192)

<a name="yyim-1739985402417"></a>[定时假设三种系统模型：](#iyps-1711639179162)

<a name="tknz-1739985402419"></a>[同步模型synchronous model: 网络延迟，暂停和时钟漂移不会超过某个固定上限；](#pgo0-1711640511485)

<a name="unfy-1739985402421"></a>[部分同步模型partial synchronous：大多数情况像一个同步系统一样运行，有时出现超时，进程暂停和时钟漂移界限](#h1x4-1711640383000)

<a name="uhct-1739985402423"></a>[异步模型：一个算法不允许对实际做任何假设，事实上它甚至没有时钟。](#vkkn-1711640459345)

<a name="t6ar-1739985402425"></a>[节点系统模型：-节点失效问题](#lg5f-1711640536166)

<a name="q8hi-1739985402427"></a>[崩溃停止crash-stop:只能由崩溃失效，且永远不会回来。](#ahco-1711640498506)

<a name="dfzo-1739985402429"></a>[崩溃恢复crash-recovery: 具有稳定存储（非易失性磁盘），崩溃中保留，内存中状态会丢失-innodb三阶段提交](#35nl-1711640632666)

<a name="wqnh-1739985402431"></a>[拜占庭（任意）故障：节点可以做任何事情，包括戏弄和欺骗其他节点](#rpmc-1711640822813)

<a name="6iu5-1739985402433"></a>[具有崩溃恢复的部分同步模型是最有用的模型。分布式算法如何应用这种模型](#6gea-1711640879281)

<a name="rtkw-1739985402435"></a>[算法的正确性](#hwoz-1711387576180)

<a name="xbpz-1739985402437"></a>[描述属性：定义算法的正确性](#i9kv-1711640972087)

<a name="o4lx-1739985402439"></a>[锁生成屏蔽令牌，要求具有以下属性：](#qsck-1711641049261)

<a name="icjj-1739985402441"></a>[唯一性：没有两个屏蔽令牌请求返回相同的值](#tvxj-1711641079676)

<a name="bqsr-1739985402443"></a>[单调序列：时序实现单调](#2d0a-1711641105012)

<a name="g7pg-1739985402445"></a>[可用性：请求防护令牌且不会崩溃的节点，最终会收到响应](#mlbd-1711641130527)

<a name="pxrt-1739985402447"></a>[安全性和活性](#1lz8-1711387585629)

<a name="uwxx-1739985402449"></a>[澄清这种情况，需区分两种不同性质](#hctm-1711641203049)

<a name="ftd8-1739985402451"></a>[安全性safety: 唯一性和单调序列](#k48b-1711641295367)

<a name="pzyu-1739985402453"></a>[活性：可用性](#fmy7-1711641313609)

<a name="pdwk-1739985402455"></a>[将系统模型映射到现实世界](#ndiw-1711387592922)

<a name="hvnq-1739985402457"></a>[9.一致性共识](#rp9s-1705080859004)

<a name="l4ww-1739985402459"></a>[共识consensus: 让所有节点对某件事达成一致](#vrvh-1712996687843)

<a name="n47t-1739985402461"></a>[脑裂brain split: 两个节点都认为自己是master, 经常导致数据丢失；](#oqcs-1712996726634)

<a name="mu6e-1739985402463"></a>[一致性保证](#obqn-1711730044966)

<a name="o4ys-1739985402465"></a>[最终一致性：收敛convergence, 最终收敛到相同的值](#ku5g-1712996774138)

<a name="w1qs-1739985402467"></a>[事务一致性：避免同时执行事务导致的竞争状态](#ga60-1712996859001)

<a name="bwgn-1739985402469"></a>[分布式一致性模型：面对延迟和故障时，如何协调副本间的状态](#eovi-1712996916251)

<a name="uuiq-1739985402471"></a>[线性一致性](#thyh-1711730049653)

<a name="bipf-1739985402473"></a>[背后的想法：原子一致性atomic consistency, 强一致性strong consistency, 立即一致性 immediate consistency ,外部一致性 external consistency](#bvre-1712997165569)

<a name="syea-1739985402475"></a>[看起来只有一个数据副本，实际有多个副本 - 强一致性就是逆分布式化，看成一个整体。](#qbsw-1712997247742)

<a name="oxgy-1739985402477"></a>[线性一致是一个新鲜度保证 recency gurantee;](#f0su-1712997377059)

<a name="6vev-1739985402479"></a>[非线性一致的例子： world cup ,  alice refresh - DB1 return germany 1: 0 argentina won ;  bob refresh website - DB2(un asychronize) return still playing;](#mtb7-1712997407717)

<a name="m7fz-1739985402481"></a>[为什么使得系统线性一致？](#qimr-1711730403998)

<a name="e449-1739985402483"></a>[例子：CAS使得多个客户端并发按序更新](#ffat-1712998155207)

<a name="np51-1739985402485"></a>[线性一致性与可序列化是两种完全不同的保证：](#3elk-1712997586736)

<a name="wjgg-1739985402487"></a>[可序列化serializeble: 单对象或者多对象操作，确保按照某种顺序执行](#qpvu-1712998010030)

<a name="qr0r-1739985402489"></a>[线性一致性Linearizability:是读取和写入寄存器（单个对象）的新鲜度保证，不会将操作组合为事务，不会阻止写入偏差等问题](#ojsh-1712998125336)

<a name="cwrd-1739985402491"></a>[单副本强可串行性strong-1SR: 一个数据库可提供可串行性和线性一致, 基于两阶段锁2PL和实际串行执行通常是线性一致的](#5hda-1712998332148)

<a name="fcb9-1739985402493"></a>[SSI一致性快照不是线性一致的：不会包括比快照更新的写入；-不会阻塞非写的读。](#obfn-1712998432352)

<a name="tgrv-1739985402495"></a>[依赖线性一致性](#bje8-1711730427157)

<a name="5yeo-1739985402497"></a>[锁定与领导选举](#xyll-1711730652620)

<a name="cavj-1739985402499"></a>[领导选举的一种方法：每个节点启动时尝试获取锁，成功者称为领导者。](#2fqs-1712998599719)

<a name="z78c-1739985402501"></a>[保证锁时线性一致的： zookeeper 和 etcd 协调服务的一致性算法。curator基于zookeeper上更高级别的配方](#cbzr-1712998723133)

<a name="jjru-1739985402503"></a>[约束和唯一性保证](#gpva-1711730659968)

<a name="1enl-1739985402505"></a>[这种情况类似于一个锁，锁定用户名。该操作与原子性的cas类似：](#9jmj-1712998930168)

<a name="if5h-1739985402507"></a>[用户名和邮箱；](#lhyk-1712999021176)

<a name="3ya9-1739985402509"></a>[银行账号不为负数；](#7sgo-1712999031257)

<a name="9iew-1739985402511"></a>[航班剧院预定了同一时间同一位置](#so5k-1712999045093)

<a name="bfrw-1739985402513"></a>[实际应用中，处理这些限制有时可以接受。如调换位置并补偿。](#q05j-1712999070223)

<a name="mf9f-1739985402515"></a>[跨信道的时序依赖](#7cbv-1711730671963)

<a name="wzjh-1739985402517"></a>[将用户上传的照片降低分辨率以加快下载速度：](#cqkp-1712999245541)

<a name="wwrp-1739985402519"></a>[步骤：消息队列一般针对较短的消息而设计，一张图片可能达到几M.所以步骤为](#3zoo-1712999362806)

<a name="nrf8-1739985402521"></a>[1.上传照片-  web server-2.  (store img) 存储文件服务器  ](#umkb-1712999318589)

<a name="lopo-1739985402523"></a>[  | 3. send message  || 5.fetch full size img  6.store resized img](#er8u-1712999518585)

<a name="tepz-1739985402525"></a>[消息队列   - 4.deliver message     image resizer](#iiv4-1712999532781)

<a name="t8f3-1739985402527"></a>[问题：存储和缩放存在两个不同的信道，没有线性一致的新鲜度保证](#0yys-1712999647965)

<a name="snjj-1739985402529"></a>[3和4可能比存储服务器内部的复制更快，当5时，可能会看到图像旧版本或者什么都没有，如果处理的是旧版本，则产生不一致。](#xtun-1712999768959)

<a name="hwow-1739985402531"></a>[实现线性一致性的系统](#ytt0-1711730433598)

<a name="ik7s-1739985402533"></a>[单主复制（可能线性一致）protential潜在线性一致：](#j997-1712999879559)

<a name="sxnf-1739985402535"></a>[快照隔离并发错误；](#t174-1712999979364)

<a name="z3ip-1739985402537"></a>[脑裂；异步复制延迟，故障切换](#hh6o-1712999996439)

<a name="fsko-1739985402539"></a>[共识算法（线性一致）：共识算法可以安全实现线性一致性的存储，zookeeper 和 etcd](#z3nq-1713000050923)

<a name="yn7a-1739985402541"></a>[多主复制（非线性一致）：同时多个节点上处理写入，异步复制到其他节点，会产生冲突的写入](#q0kz-1713000066034)

<a name="9jno-1739985402543"></a>[无主复制（也许不是线性一致的）：Dynamo风格，法定人数读写获得强一致性。通常不完全正确](#ca4m-1713030167882)

<a name="pyxs-1739985402545"></a>[线性一致性和法定人数](#9gst-1711730681011)

<a name="aekz-1739985402547"></a>[最安全的做法是：假设采用Dynamo风格的无主复制的系统是不能提供线性一致性。](#sqvx-1713030399799)

<a name="u33x-1739985402549"></a>[线性一致性的代价](#vpxf-1711730440465)

<a name="guk8-1739985402551"></a>[CAP定理](#fqqf-1711730717308)

<a name="r67e-1739985402553"></a>[不仅是单主多主复制的后果，任何线性一致性的数据库都有这个问题：](#8hzl-1713030564813)

<a name="upkg-1739985402555"></a>[.应用需要线性一致性，副本因为网络问题断开连接，请求必须等到网络问题解决或直接返回错误（不可用unavailable）](#7lux-1713030592466)

<a name="ju3f-1739985402557"></a>[.网络断开也可独立处理请求（如多主复制），可以在网络问题前保持可用，但其行为不是线性一致的。](#48wk-1713031150235)

<a name="5ezy-1739985402559"></a>[CAP定理没有帮助：网络分区是不可避免的，所以只能是AP 或 CP。](#lsdc-1713031249676)

<a name="po7f-1739985402561"></a>[线性一致性和网络延迟](#kxsm-1711730728177)

<a name="6lto-1739985402563"></a>[ 线性一致的系统惊人的少。例如多核CPU并没有保证一定能读到第一个线程写入的值（除非使用内存屏障memory barrier或围栏fence）](#lbl2-1713031508671)

<a name="yw2k-1739985402565"></a>[ 牺牲线性一致性的原因是性能performance. 内存访问先走缓存，副本都是异步更新的，所以失去了线性一致性。](#pnsn-1713031585885)

<a name="bt12-1739985402567"></a>[搞笑的线性一致性存储不可实现。](#8y6v-1713031685808)

<a name="rubi-1739985402569"></a>[顺序保证](#on5f-1711730057760)

<a name="rxgv-1739985402571"></a>[写入顺序order of write: 单主复制的主要目的就是复制日志中确定写入顺序。](#dhiv-1713031758875)

<a name="7vnn-1739985402573"></a>[序列顺序serial order：某种序列顺序some sequential order](#cyfr-1713031815356)

<a name="qfza-1739985402575"></a>[顺序与因果](#z48k-1711730472679)

<a name="lpil-1739985402577"></a>[顺序有助于保持因果关系causality](#khzl-1713031939113)

<a name="2waf-1739985402579"></a>[一致前缀读：先看到答案再看到问题。违背因cause果effect. 存在因果依赖causal dependency](#nbes-1713031966982)

<a name="kl6q-1739985402581"></a>[更新不存在的记录：3位领导者间的复制，一些写入会压到其他写入。一条记录需被创建才能更新。](#xehj-1713032060272)

<a name="hg19-1739985402583"></a>[检测并发写入：A和B并发，则不知道顺序，A和B不知道彼此。](#v1kv-1713032135082)

<a name="ai4c-1739985402585"></a>[快照隔离：写偏差read skew，读取的数据违反因果关系（不可重复读）](#ozi8-1713032226341)

<a name="aqwd-1739985402587"></a>[事务的写偏差write skew：幻读和值班。](#pgzq-1713032264605)

<a name="yu5p-1739985402589"></a>[世界杯球赛结果，跨信道的时序依赖。](#3ang-1713032756197)

<a name="efse-1739985402591"></a>[因果一致causally：系统服从因果关系锁规定的顺序。](#tryg-1713032788961)

<a name="tmrv-1739985402593"></a>[因果顺序不是全序的](#niwx-1711730751513)

<a name="luhh-1739985402595"></a>[全序total order: 自然数更大或更小，总是有序的](#x8gk-1713086054855)

<a name="s4su-1739985402597"></a>[偏序partially order: 一个集合大于另一个集合，但是其它情况下无法比较](#wvsa-1713086222914)

<a name="rg5r-1739985402599"></a>[线性一致性：操作是全序的，系统表现好像只有一个副本，所有操作都是原子性的。意味对每个操作总能判定发生顺序](#u7jq-1713086312064)

<a name="jto6-1739985402601"></a>[因果性：两个操作没在彼此之前发生，即并发无法比较顺序，意味着因果关系定义了一个偏序，而不是全序。一些有序一些无序](#xa0w-1713086399916)

<a name="f4x4-1739985402603"></a>[线性一致的数据存储中是不存在并发操作的。确保每个请求都是在唯一时间线上自动处理](#uaxz-1713086531138)

<a name="eoho-1739985402605"></a>[并发意味着时间线会分叉然后合并。操作的偏序：](#qs64-1713086635361)

<a name="1ztu-1739985402607"></a>[类似git系统，一个提交commit发生在另一个提交之后。分支合并merge会在这些并发创建的提交相融合时创建。](#ctkd-1713086670170)

<a name="ftzw-1739985402609"></a>[线性一致性强于因果一致性](#qdnf-1711730766239)

<a name="sdlu-1739985402611"></a>[线性一致性隐含implies着因果关系;](#dam4-1713086279684)

<a name="4ps6-1739985402613"></a>[捕获因果关系](#uqqx-1711730776113)

<a name="uq7f-1739985402615"></a>[为了维持因果性，需确认操作发生在哪个操作之前happened before:](#agrw-1713086796608)

<a name="f4n2-1739985402617"></a>[刑侦决定Y时是否知到X与Y因果关系](#rys3-1713086865582)

<a name="ogxh-1739985402619"></a>[检测并发写入：推广版本向量解决因果依赖](#znup-1713086911030)

<a name="appx-1739985402621"></a>[SSI序列化隔离快照：事务提交时，检测读取是否最新，为此跟踪哪些事务被那些事务锁读取。](#1ivk-1713086936754)

<a name="s78o-1739985402623"></a>[序列号顺序](#jsuf-1711730485869)

<a name="rvfv-1739985402625"></a>[序列号sequence number或时间戳timestamp](#y9ti-1713091524670)

<a name="nioe-1739985402627"></a>[非因果序列号生成器](#qpya-1711730796494)

<a name="hhs4-1739985402629"></a>[兰伯特时间戳](#mtzj-1711730811106)

<a name="twig-1739985402631"></a>[兰伯特时间戳提供了与因果关系一致的总排序：施行一个全序](#f8uv-1713091653199)

<a name="qkzb-1739985402633"></a>[检测并发写入有着不同目的：区分两个操作是并发的，一个因果依赖另一个。](#2ayx-1713091789731)

<a name="5n42-1739985402635"></a>[光有时间戳排序还不够](#elc6-1711730816628)

<a name="wkcx-1739985402637"></a>[全序广播](#aw2l-1711730490423)

<a name="9sgr-1739985402639"></a>[可靠交付reliable delivery：没有消息丢失，如果消息被传递到一个节点，它将被传递到所有节点](#axul-1713091937508)

<a name="q689-1739985402641"></a>[全序交付totally ordered delivery: 消息以相同的顺序传递给每个节点。](#cruc-1713091989510)

<a name="znu0-1739985402643"></a>[使用全序广播](#hp3a-1711730834892)

<a name="qulf-1739985402645"></a>[zookeeper和etcd共识服务实际上实现了全序广播](#ztws-1713108978601)

<a name="rezv-1739985402647"></a>[状态机复制state machine repliacation: 每个副本都按相同的顺序处理相同的写入。](#i8bk-1713109007327)

<a name="nowo-1739985402649"></a>[与之类似，使用全序广播来实现可序列化的事务：真的串行执行，确定的事务以存储过程来执行，每个节点以相同的顺序处理这些消息。](#8jch-1713109071990)

<a name="2wpf-1739985402651"></a>[以及防护令牌的锁服务，全序广播使得所有消息按顺序一次编号，序列号可当做防护令牌(单调递增)，zookeeper中这个序列号称为zxid;](#w19a-1713109204107)

<a name="eoqp-1739985402653"></a>[使用全序广播实现线性一致的存储](#i3vg-1711730844593)

<a name="mpb9-1739985402655"></a>[使用线性一致性存储实现全序广播](#xlae-1711730855140)

<a name="sihq-1739985402657"></a>[分布式事务与共识](#y1bv-1711730380233)

<a name="jojv-1739985402659"></a>[让几个节点达成一致get serveral nodes to agree on somthing](#yt5r-1713109388776)

<a name="tci7-1739985402661"></a>[领导选举：避免脑裂](#d7t7-1713109479427)

<a name="bebf-1739985402663"></a>[原子提交atomic commit：多节点事务提交/中止/回滚](#frsp-1713109508353)

<a name="lx7f-1739985402665"></a>[原子提交与两阶段提交2PC](#abk6-1711730509647)

<a name="gy9a-1739985402667"></a>[原子性可以避免中间态，多对象事务原子性确保二级索引与主数据库保持一致。](#0h2f-1713110484428)

<a name="dvl7-1739985402669"></a>[从单节点到分布式原子提交](#iqfd-1711730882368)

<a name="hbnc-1739985402671"></a>[从数据库的角度看，这是单独的事务，任何跨事务正确性的保证都是应用自己的问题。](#h1ym-1713110537245)

<a name="tbld-1739985402673"></a>[2PC两阶段提交简介](#roa9-1711730906391)

<a name="krwu-1739985402675"></a>[coodinator协调子事务，子事务单独执行完，在准备阶段询问是否可提交](#vaax-1705118249954)

<a name="y5zg-1739985402677"></a>[.全部为是，则分别提交。](#7zwc-1705118288968)

<a name="qceh-1739985402679"></a>[.其中有否，则中断回滚。](#3b8s-1705118337513)

<a name="tg68-1739985402681"></a>[系统承诺](#kpgk-1711730913393)

<a name="6tzm-1739985402683"></a>[一旦协调者做出决定，这一决定是不可撤销的。](#wkui-1713110739239)

<a name="d6m9-1739985402685"></a>[协调者失败](#qhdj-1711730921387)

<a name="axqm-1739985402687"></a>[参与者投赞成票后，参与者协调者崩溃，数据库1不知道是否提交或中止。](#jpd8-1713110804532)

<a name="nvbs-1739985402689"></a>[三阶段提交](#ixzv-1711730924556)

<a name="n3et-1739985402691"></a>[阻塞blocking原子提交协议, 2PC可能卡主等待协调者恢复的情况。](#edp3-1713111179295)

<a name="eu92-1739985402693"></a>[在提交阶段，如果子事务进程crash,或者协调者崩溃的时的解决方案，弱原子性，最终一致性。](#llyc-1711731148564)

<a name="p2z5-1739985402695"></a>[许多coodinator不支持高可用或者只支持基本的复制](#nlrk-1705118500709)

<a name="mxyf-1739985402697"></a>[实践中的分布式事务](#xexf-1711730524691)

<a name="c2ug-1739985402699"></a>[云服务由于其导致的运维问题而选择不实现分布式事务。](#inqh-1713111548114)

<a name="ijon-1739985402701"></a>[两阶段难以实现安全保证，且导致的运维问题造成性能下降。](#zuho-1713111590325)

<a name="czgj-1739985402703"></a>[数据库内部的分布式事务](#gf92-1711731287296)

<a name="90dp-1739985402705"></a>[VoltDB 与mysql Cluster 的NDB引擎就有这样的内部事务支持。](#jhqw-1705080950920)

<a name="opaq-1739985402707"></a>[异构分布式事务](#gvng-1713111648038)

<a name="qj0b-1739985402709"></a>[保证异构数据库的事务更有挑战性](#st60-1713111659854)

<a name="avw7-1739985402711"></a>[恰好一次的消息处理](#btdt-1711730944613)

<a name="l6ii-1739985402713"></a>[XA事务eXtended Architecture](#qvbk-1711730954739)

<a name="oujv-1739985402715"></a>[怀疑时持有锁](#med0-1711730959684)

<a name="ouiz-1739985402717"></a>[从协调者故障中恢复](#ouyq-1711730969007)

<a name="ehh5-1739985402719"></a>[唯一的出路是让管理员手动决定提交还是回滚事务](#ouur-1713116418144)

<a name="602t-1739985402721"></a>[分布式事务的限制](#gzya-1711730975747)

<a name="tpwb-1739985402723"></a>[协调者本身就是一种数据库，存储了事务的结果。](#jkt3-1713116480399)

<a name="l66u-1739985402725"></a>[协调者默认不是高可用的，只有基本的复制](#mcvv-1713116529836)

<a name="is2x-1739985402727"></a>[应用服务器不再是无状态的了](#h6gt-1713116550997)

<a name="von2-1739985402729"></a>[不能检测不同系统间的死锁，且无法与SSI协同工作](#rrrl-1713116568769)

<a name="qp3n-1739985402731"></a>[与构建容错系统的目标背道而驰，分布式事务有扩大失效amplifying failures的趋势](#wbzw-1713116600081)

<a name="5iqq-1739985402733"></a>[容错共识](#npne-1713118985168)

<a name="qo4k-1739985402735"></a>[一个或多个节点提议propose某些值，共识算法决定decides采用其中的某个值。](#beiq-1713118985169)

<a name="1xxh-1739985402737"></a>[一致同意Uniform agreement:  没有两个节点的决定不同-核心 决定了相同的结果，一旦决定不能改变](#pq0x-1713118985170)

<a name="5pht-1739985402739"></a>[完整性Integrity: 没有节点决定两次-核心](#xnwp-1713118985171)

<a name="fxnq-1739985402741"></a>[有效性validity: 如果一个节点决定了值v, 则v由某个节点所提议-排除平凡的解决方案](#2bty-1713118985172)

<a name="b46q-1739985402743"></a>[终止Termination由所有为崩溃的几点来最终决定值。-活性属性，必须取得进展，即使部分节点出现故障，其他节点也必须达成一致。不超过一般的节点崩溃或不可达](#9k32-1713118985173)

<a name="xgna-1739985402745"></a>[稳健达成共识：只要少于三分之一的节点存在拜占庭故障](#scne-1713118985174)

<a name="bcog-1739985402747"></a>[共识算法和全序广播](#prxr-1713118985175)

<a name="9ax0-1739985402749"></a>[视图戳复制VSR viewstamped repliacation, Paxos，Raft, Zab](#zmcg-1713118985176)

<a name="ods8-1739985402751"></a>[全序广播相当于重复进行多轮共识：](#1u8f-1713118985177)

<a name="exb2-1739985402753"></a>[一致同意属性，所有节点决定以相同的顺序传递相同的消息](#d2l2-1713118985178)

<a name="ybwr-1739985402755"></a>[完整性属性，消息不会重复](#z7u4-1713118985179)

<a name="yoxh-1739985402757"></a>[有效性属性，消息不会被破坏，也不能凭空编造](#pphb-1713118985180)

<a name="yf7y-1739985402759"></a>[终止属性,消息不会丢失](#gqmq-1713118985181)

<a name="cozf-1739985402761"></a>[视图戳复制，raft和zab直接实现了全序广播，比重复一次一致one value a time的共识更高效， paxos 下这种优化称为multi-paxos.](#lxll-1713118985182)

<a name="u2vt-1739985402763"></a>[单领导者复制和共识](#krsz-1713118985183)

<a name="dkw4-1739985402765"></a>[时代编号和法定人数](#90tt-1713118985184)

<a name="vqpy-1739985402767"></a>[共识的局限性](#qywj-1713118985185)

<a name="tvnl-1739985402769"></a>[成员与协调服务](#8qzt-1713118985186)

<a name="xa4y-1739985402771"></a>[将工作分配给节点](#4tlb-1713118985187)

<a name="aezj-1739985402773"></a>[服务发现](#tbbj-1713118985188)

<a name="agdh-1739985402775"></a>[成员服务](#1lld-1713118985189)

<a name="1kxi-1739985402777"></a>[第三部分：衍生数据](#46k8-1705118453932)

<a name="scjx-1739985402779"></a>[记录和衍生数据系统](#rboc-1716226529015)

<a name="phdz-1739985402781"></a>[从高层次看，存储和处理数据的系统可以分为两大类](#cmdh-1716226737947)

<a name="6scf-1739985402783"></a>[记录系统System of record](#1dmv-1716226552894)

<a name="fj3w-1739985402785"></a>[真相源source of truth. 记录用户输入新数据，标准化normalized](#dh96-1716226777418)

<a name="1gqj-1739985402787"></a>[衍生数据系统Derived data system](#qjlf-1716226568395)

<a name="aijr-1739985402789"></a>[缓存cache, 衍生数据是冗余的，重复了已有的信息。](#igtl-1716226871151)

<a name="f8sq-1739985402791"></a>[10.批处理](#0bgb-1716226496297)

<a name="i6gf-1739985402793"></a>[服务（在线系统）：高可用性，性能指标-响应时间](#yygb-1720542683707)

<a name="97ep-1739985402795"></a>[批处理系统（离线系统）：定时任务job，性能指标-吞吐量](#goo7-1720542700859)

<a name="zbeg-1739985402797"></a>[流处理系统（准实时系统）：介于在线离线系统之间](#mv2a-1720542952432)

<a name="tw0y-1739985402799"></a>[使用Unix工具的批处理](#6lu4-1716228538928)

<a name="bpe8-1739985402801"></a>[分析简单日志](#hyii-1716228597300)

<a name="kai4-1739985402803"></a>[Unix命令链：网站上找到五个最受欢迎的网页（nginx/access.log）](#smoq-1720543218731)

<a name="8bem-1739985402805"></a>[命令链与自定义程序Ruby](#ukyi-1716228816049)

<a name="yrbh-1739985402807"></a>[排序 VS 内存中的聚合](#cnuw-1716228829632)

<a name="1cpg-1739985402809"></a>[工作集working set(作业需要随机访问的内存大小)，单个url 重复出现百万次，哈希表性能好](#siiu-1720543940755)

<a name="txow-1739985402811"></a>[工作集大于内存，排序优，与SSTables 和 LSM树一样，内存聚合归并排序，GNU 中的sort通过溢出至磁盘自动应该大于内存大额数据集，瓶颈可能是磁盘io。-MQ的死信处理也是溢出到磁盘。](#lms0-1720544023798)

<a name="ks77-1739985402813"></a>[Unix哲学](#mgei-1716228613042)

<a name="wsse-1739985402815"></a>[统一的接口](#sk3b-1716228852580)

<a name="yyhu-1739985402817"></a>[Unix中统一的接口是一个文件file](#33ju-1720874904091)

<a name="j66t-1739985402819"></a>[ASCII文本，\n 分隔，](#yogq-1720875513301)

<a name="c0qa-1739985402821"></a>[CSV， ，号分隔](#7fvb-1720875542091)

<a name="99yv-1739985402823"></a>[逻辑与布线相分离](#3oxq-1716228869387)

<a name="anqc-1739985402825"></a>[松耦合loose coupling](#0zy9-1720876020643)

<a name="q7kv-1739985402827"></a>[晚期绑定late binding](#226j-1720876035472)

<a name="mbmw-1739985402829"></a>[控制反转inversion of control](#zedb-1720876065554)

<a name="dohu-1739985402831"></a>[透明度与实验](#ftj8-1716228879278)

<a name="rzbc-1739985402833"></a>[MapReduce和分布式文件系统](#djdy-1716228554334)

<a name="e7ve-1739985402835"></a>[MapReduce像是分布在数前台机器上的Unix。](#illh-1720876369554)

<a name="ifko-1739985402837"></a>[Hadoop的Map-Reduce视线中，文件系统成为HDFS,基于google文件系统GFS的开源实现。](#e1cy-1720876447842)

<a name="uuvm-1739985402839"></a>[Amazon S3，  Azure blob ](#mapk-1720876955975)

<a name="qfeq-1739985402841"></a>[MapReduce作业执行](#kdge-1716228625984)

<a name="dmey-1739985402843"></a>[Mapper在每条输入记录上调用一次,从输入记录中提取键值（提取键值）](#vleh-1720877349422)

<a name="yh4g-1739985402845"></a>[Reduce拉取Mapper生成的键值对，收集属于同一个键的所有值。（收集同键的所有值）](#aol7-1720877397533)

<a name="doks-1739985402847"></a>[分布式执行MapReduce](#kv6u-1716231603620)

<a name="d2wj-1739985402849"></a>[即在不同服务器上执行mapper reduce 的task。](#wy7r-1720877483243)

<a name="cnnt-1739985402851"></a>[MapReduce工作流](#d0qe-1716231619319)

<a name="qlf4-1739985402854"></a>[workflow。一系列命令，输出写入临时文件，下一个命令从临时文件中读取-物化中间状态](#rvme-1720877910897)

<a name="zy17-1739985402856"></a>[Reduce端连接与分组](#pyoc-1716228643855)

<a name="cbde-1739985402858"></a>[用户活动事件](#1pza-1716231634942)

<a name="1nzy-1739985402860"></a>[左侧是事件日志/活动事件activity events/点击流事件clickstream evnets](#4l72-1720878002631)

<a name="t9m2-1739985402862"></a>[右侧是用户数据库](#hivt-1720878131008)

<a name="z3ee-1739985402864"></a>[用户行为日志与用户档案的连接](#cvii-1720878237531)

<a name="pjyv-1739985402866"></a>[原始:逐个遍历活动事件关联查询。缺点：吞吐量受限数据库服务器且容易压垮](#eiqe-1720878248508)

<a name="sn87-1739985402868"></a>[改良：获取用户数据库副本（ETL进程从数据库备份中提取数据，参考数仓），放在同一个分布式文件系统中。将用户数据库存储HDFS中的一组文件中，用户活动记录存储另一组文件中，](#iueg-1720878322010)

<a name="eica-1739985402870"></a>[并能用MapReduce将左右相关记录集中到同一个地方进行高效处理。](#ruua-1720878498786)

<a name="1lqy-1739985402872"></a>[排序合并连接](#fihy-1716231663765)

<a name="lzte-1739985402874"></a>[1.map提取键值(userid-url  usrid-do)和reduce(userid all url do)](#q51q-1720947527716)

<a name="wwm0-1739985402876"></a>[2.二次排序secondary sort ：对1的合并按时间戳排序](#4kvv-1720947648039)

<a name="oemk-1739985402878"></a>[排序合并连接sort-merge join: reduce一次处理一个特定用户所有记录，只需将一条用户记录保存在内存中，无需发送网络请求](#j8br-1720947805879)

<a name="m1fr-1739985402880"></a>[把相关数据放在一起](#8vrk-1716231670998)

<a name="ux6i-1739985402882"></a>[Mapper和排序过程确保特定用户id连接操作的必须数据都放在同一个地方](#t1tc-1720947947656)

<a name="swhe-1739985402884"></a>[GROUP BY](#9j4s-1716228658160)

<a name="xmxb-1739985402886"></a>[除了连接之外，“把相关数据放在一起”的常见模式是记录分组。SQL中的Group By](#a6wg-1720952083180)

<a name="ys3j-1739985402888"></a>[处理倾斜](#qa24-1716231688547)

<a name="akq1-1739985402890"></a>[名流热点数据hot spot](#f55j-1720952155251)

<a name="tm3d-1739985402892"></a>[参考负载倾斜和消除热点](#julg-1720952222343)

<a name="7kk3-1739985402894"></a>[Mapper将热键的关联记录随机发送到几个Reduce之一](#akfb-1720952286891)

<a name="0ebp-1739985402896"></a>[Map端连接](#2tox-1716228671225)

<a name="xnla-1739985402898"></a>[预处理输入数据](#qiil-1720971178915)

<a name="t17b-1739985402900"></a>[广播散列连接](#wjhj-1716231713037)

<a name="juyi-1739985402902"></a>[broadcast hash join](#k3se-1720971260954)

<a name="teie-1739985402904"></a>[分区散列连接](#su27-1716231723170)

<a name="ozz3-1739985402906"></a>[Map桶端连接bucketd map jons](#5h9a-1720971514797)

<a name="pg4d-1739985402908"></a>[Map端合并连接](#ftdq-1716231736611)

<a name="84g8-1739985402910"></a>[MapReduce工作流与Map端连接](#yrmc-1716231744413)

<a name="3rjx-1739985402912"></a>[批处理工作流的输入](#zzir-1716228678980)

<a name="4y2n-1739985402914"></a>[OLTP ：查找少量记录，使用索引，呈现给用户](#hiqn-1720971586510)

<a name="zclg-1739985402916"></a>[OLAP：扫描大量记录，执行分组与聚合，输出有着报告的形式，商业决策的分析。](#cqba-1720971612883)

<a name="9vjg-1739985402918"></a>[建立搜索索引](#bwjf-1716231761454)

<a name="ywke-1739985402920"></a>[MapReduce最初作为google搜索引擎的索引](#lypn-1720971694941)

<a name="d3lj-1739985402922"></a>[全文搜索和模糊索引  Lucene](#iijq-1720971776882)

<a name="xbke-1739985402924"></a>[分区和二级索引](#vcun-1720971828838)

<a name="okjp-1739985402926"></a>[键值存储作为批处理输入](#8fix-1716231782091)

<a name="6w7v-1739985402928"></a>[批处理输入的哲学](#audd-1716231802005)

<a name="q5ro-1739985402930"></a>[视为不可变且避免副作用：](#6i34-1720972317458)

<a name="ukug-1739985402932"></a>[人类容错human fault tolerance](#zciu-1720972319614)

<a name="uxjf-1739985402934"></a>[最小化不可逆性mininizing irreversibility](#oolm-1720972319615)

<a name="sezi-1739985402936"></a>[Hadoop与分布式数据库的对比](#lp33-1716228684462)

<a name="hqop-1739985402938"></a>[Hadoop 像Unix的分布式版本，HDFS是它的文件系统，而MapReduce是Unix进程的怪异实现](#g0vj-1720972341966)

<a name="vkxj-1739985402940"></a>[MapReduce论文发表前，并行连接算法已在数据库实现-大规模并行处理MPP massively parallel processing ](#gjbt-1720972427948)

<a name="upik-1739985402942"></a>[Gamma database machine, Teradata, Tandem NonStop SQL](#go7m-1720972523351)

<a name="gppz-1739985402944"></a>[区别：MMP专注一组及骑行并行执行分析SQL 查询](#5mnr-1720972551600)

<a name="okde-1739985402946"></a>[MapReduce和分布式文件系统的组合是一个可以运行任意程序的通用操作系统](#gx7b-1720972580058)

<a name="wc2c-1739985402948"></a>[存储多样性](#eebl-1716231817367)

<a name="allb-1739985402950"></a>[数据湖data lake / 企业数据中心enterprise data hub](#5lga-1720972673599)

<a name="ofki-1739985402952"></a>[Hadoop 常用于实现数仓ETL Extract, Transform, Load](#jrhw-1720972777529)

<a name="eq10-1739985402954"></a>[处理模型多样](#ysfv-1716231826972)

<a name="zy5k-1739985402956"></a>[针对频繁故障设计](#kwz4-1716231831752)

<a name="snag-1739985402958"></a>[MapReduce之后](#p0zx-1716228568687)

<a name="bie7-1739985402960"></a>[建立在MapReduce上的高级编程模型](#wcyn-1721117329960)

<a name="nmyk-1739985402962"></a>[Pig，Hive, Cascading, Crunch](#l9ug-1721117359714)

<a name="ucqv-1739985402964"></a>[流处理：加速批处理的另一种方法](#bz2s-1721117576614)

<a name="g5pc-1739985402966"></a>[物化中间状态](#fvak-1716228706372)

<a name="9hvt-1739985402968"></a>[中间状态intermediate state](#npb7-1721117756510)

<a name="dcxr-1739985402970"></a>[物化materialization:中间态写入文件的过程](#0rlu-1721117876651)

<a name="3md2-1739985402972"></a>[MapReduce完全物化中间态的方法不足：](#fnqf-1721117967688)

<a name="tsik-1739985402974"></a>[只有在前驱作业生成其输入完成时才能启动](#pood-1721117984973)

<a name="aoen-1739985402976"></a>[mapper通常是多余的：仅仅读取由Reducer写入的同样文件](#iljf-1721118032959)

<a name="ibep-1739985402978"></a>[临时文件（数据）被复制到多个节点](#tghz-1721118071785)

<a name="eo5b-1739985402980"></a>[解决：数据流引擎](#aer2-1721118148615)

<a name="hknm-1739985402982"></a>[数据流引擎](#sdac-1716231877023)

<a name="kj44-1739985402984"></a>[分布式批处理新引擎：](#4gu5-1721118111495)

<a name="yjpb-1739985402986"></a>[spark,  Flink: 独立的网络通信层，调度器，用户向API](#nfnv-1721118162692)

<a name="fmlz-1739985402988"></a>[Tez : 薄库，依赖YARN shuffle服务实现节点间的数据复制](#0kbz-1721123564974)

<a name="3b48-1739985402990"></a>[dataflow engines模型:](#jojo-1721118227522)

<a name="xyyv-1739985402992"></a>[函数/算子operators: 一个算子的输出连接到另一个算子的输入](#kstp-1721118246090)

<a name="317g-1739985402994"></a>[优点：](#zbrh-1721118327524)

<a name="ilns-1739985402996"></a>[排序等昂贵工作只需在实际需要地方执行，不是默认在Map和Reduce阶段间](#8oqo-1721118330975)

<a name="tezq-1739985402998"></a>[没有不必要的Map任务](#amzf-1721118375240)

<a name="k9lw-1739985403000"></a>[连接和数据依赖都是显示声明的](#bunw-1721118382779)

<a name="dp5k-1739985403002"></a>[算子中间态足以保存内存或写入本地磁盘，比HDFS需要更少I/O](#bzui-1721122836028)

<a name="iss0-1739985403004"></a>[算子可在输入就绪后立即执行，不许等待前驱完成](#ka7f-1721123164712)

<a name="0kdh-1739985403006"></a>[MapReduce为每个任务启动新JVM, 而df enginer可重用现有JVM，减少启动开销](#rmr3-1721123191298)

<a name="n2ty-1739985403008"></a>[执行速度更快](#mp4i-1721123431562)

<a name="pexn-1739985403010"></a>[使用：](#2cxo-1721123304059)

<a name="ufew-1739985403012"></a>[算子是Map和Reduce的泛化/抽象，相同处理代码可在任意引擎上运行](#vyfa-1721123442398)

<a name="uhke-1739985403014"></a>[Pig Hive Casacding中实现的工作流无需修改代码，修改配置，从MapReduce切换到Tez 或spark.](#qxck-1721123483308)

<a name="qegl-1739985403016"></a>[容错](#glfr-1716231882229)

<a name="ofvz-1739985403018"></a>[重启，算子重新计算](#neqa-1721499456929)

<a name="mr6o-1739985403020"></a>[关于物化的讨论](#npsg-1716231884238)

<a name="7ehv-1739985403022"></a>[图与迭代处理](#dvkh-1716228727874)

<a name="x6ce-1739985403024"></a>[图数据模型常用于机器学习应用](#y476-1721499725472)

<a name="p81e-1739985403026"></a>[图形算法PageRank:根据连接到某个网页的其他网页来估计该网页的流行度](#ld62-1721499760165)

<a name="umor-1739985403028"></a>[闭包传递transitive clousure: 重复跟进标明地点归属关系的边，生成数据库中北美地点列表](#et5r-1721499798288)

<a name="egl7-1739985403030"></a>[MapReduce低效：没考虑算法迭代性](#x4m1-1721499995671)

<a name="quyl-1739985403032"></a>[Pregel处理模型](#lf5y-1716231892007)

<a name="mcd9-1739985403034"></a>[图批处理的优化：批量同步并行（BSP）计算模型。](#1faf-1721499959178)

<a name="riey-1739985403036"></a>[Pregel模型：Google的Pregel论文推广了处理图的方法。Apache Giraph , Spark GraphX API 和 Flink Gelly API](#3mh8-1721500149918)

<a name="sbb6-1739985403038"></a>[容错](#pxnd-1716231909468)

<a name="kgai-1739985403040"></a>[并行执行](#v8gr-1716231912877)

<a name="wqik-1739985403042"></a>[高级API和语言](#cxqk-1716228736349)

<a name="eyhi-1739985403044"></a>[Hive,pig, Cascading,Crunch等高级语言和API, Tez](#qlnr-1721841646688)

<a name="dm2o-1739985403046"></a>[向声明式查询语言的转变](#dfa6-1716231923208)

<a name="npai-1739985403048"></a>[声明式declarative](#zman-1721841903902)

<a name="izys-1739985403050"></a>[与SQL的完全声明式查询有很大的区别：](#inea-1721841971310)

<a name="sbwc-1739985403052"></a>[围绕回调函数的概念建立，自由调用任意代码来决定输出什么。](#ahki-1721842021736)

<a name="zng9-1739985403054"></a>[可基于大量已有库的生态系统创作： 解析、自然语言分析，图像分析以及运算数值算法或统计算法等。](#bdyf-1721842047384)

<a name="7txw-1739985403056"></a>[专业化的不同领域](#m2pu-1716231937991)

<a name="5h0m-1739985403058"></a>[空间算法：最近邻搜索K-nearest neghbors](#wpot-1721842227412)

<a name="ayvk-1739985403060"></a>[11.流处理](#iwmv-1721931597264)

<a name="hvqu-1739985403062"></a>[流处理Stream processing: 当事件发生时就可以立即处理](#yeid-1722103475505)

<a name="tq9j-1739985403064"></a>[传递事件流](#08iq-1721844360659)

<a name="sfxy-1739985403066"></a>[事件event：流处理的上下文件记录](#n0th-1722103658739)

<a name="mslr-1739985403068"></a>[生产者producer/发布者publisher/发送者sender](#titb-1722103707652)

<a name="n7s1-1739985403070"></a>[消费者consumer/订阅者subscribers/接收者recipients](#yhbb-1722103745716)

<a name="4lyw-1739985403072"></a>[主题topic/流stream：相关事件的聚合](#jdqp-1722103794393)

<a name="wmk0-1739985403074"></a>[通知机制：数据库触发器trigger(算是弥补机制)、消息传递系统messaging system](#2buw-1722103875913)

<a name="ysht-1739985403076"></a>[消息系统](#ipga-1721932434160)

<a name="p7nu-1739985403078"></a>[两个关键问题：](#qm3o-1722104029796)

<a name="tsew-1739985403080"></a>[1.生产者快于消费者：丢掉消息/将消息放入缓冲队列/背压backpressure(流量控制flow control) 阻塞生产者，以免其发送更多消息](#sztq-1722104046748)

<a name="owtt-1739985403082"></a>[2.节点崩溃或脱机，是否有消息丢失： 持久性，高吞吐和低延迟则接收丢失](#5ycq-1722104289674)

<a name="60nz-1739985403084"></a>[直接从生产者传递给消费者](#cj2t-1721932544748)

<a name="u2ea-1739985403086"></a>[直接网络通信，而不通过中间节点：](#hjhp-1722104612024)

<a name="rfc0-1739985403088"></a>[UPD组播，金融行业，低延时，不可靠，应用层协议可恢复丢失的包（生产者必须记住发送的包，按需重新发送）](#0ggy-1722104631748)

<a name="tfpt-1739985403090"></a>[无代理的消息库，ZeroMQ、nanomsg, TCP或IP多播](#hnj8-1722104735615)

<a name="gwqa-1739985403092"></a>[StatsD 和 Brubeck 使用UDP](#pcd7-1722104800545)

<a name="cpgn-1739985403094"></a>[消费者在网络上公开了服务，生产者可以直接发送HTTP和RPC请求将消息推送给使用者webhooks.](#3se2-1722104863261)

<a name="fsb7-1739985403096"></a>[消息代理](#jwkh-1721932555905)

<a name="hcew-1739985403098"></a>[消息代理message broker(也称为消息队列message queue)](#dtlb-1722106424439)

<a name="yisk-1739985403100"></a>[消息代理与数据库对比](#fyus-1721932559957)

<a name="imr0-1739985403102"></a>[.数据存储：数据库保留数据直至显示删除；大多数消息代理在消息成功传递给消费者时地总删除](#aj3x-1722106519844)

<a name="y5hr-1739985403104"></a>[.删除消息快，所以队列可以很短。如过缓冲很多消息可能会溢出到磁盘，吞吐量会下降](#pkoh-1722106591225)

<a name="duvd-1739985403106"></a>[.匹配方式：数据库通常支持二级索引和各种搜索数据的方式；消息代理按照模式匹配订阅子集](#lfst-1722106688956)

<a name="didp-1739985403108"></a>[.最新数据：数据库通常支持事务，基于某个时间点数据快照；消息代理不支持任意查询，有新消息会通知客户端](#q13l-1722106755764)

<a name="uknu-1739985403110"></a>[多个消费者](#v0lh-1721932568637)

<a name="ul9z-1739985403112"></a>[负载均衡load balance: 多个客户端从同一个队列中消费。JMS中称为共享订阅shared subscripiton](#enlv-1722191268259)

<a name="boac-1739985403114"></a>[扇出fan-out:将每条消息传递给多个消费者](#bjqd-1722191397355)

<a name="nvf4-1739985403116"></a>[确认与重新交付](#aoas-1721932573289)

<a name="vy8j-1739985403118"></a>[消息代理使用确认acknowlegements:客户端需显示告知代理消息处理完毕的时间，代理将消息从队列中移除。](#8lsc-1723155930519)

<a name="jcvy-1739985403120"></a>[确认丢失：需一种原子提交协议才能处理，如分布式事务。](#w6ac-1723156157534)

<a name="gp62-1739985403122"></a>[负载均衡与重传的组合不可避免导致消息顺序(JMS，AMQP标准要求保留消息的顺序。)重新排序](#zlnz-1723156224601)

<a name="0wg5-1739985403124"></a>[解决：每个消费者使用单独的队列-即不适用负载均衡功能](#fovj-1725028626326)

<a name="42ql-1739985403126"></a>[消息完全独立，消息重排序并不是个问题，消息之间存在因果依赖关系则是个重要问题](#3kzh-1725028667923)

<a name="c8lv-1739985403128"></a>[分区日志](#9bmj-1721932438668)

<a name="ravm-1739985403130"></a>[消息传递/不留痕迹：网络数据包 和 消息代理 (可抓包和日志持久)](#xree-1725028818863)

<a name="7nhj-1739985403132"></a>[持久化：数据库和文件系统，显式删除前将永久记录](#sbbo-1725028858585)

<a name="pnuo-1739985403134"></a>[消息代理log-base message brokers: 既有数据库的持久化，又有消息传递的低延迟通知。](#n6lq-1725028981222)

<a name="hizy-1739985403136"></a>[使用日志进行消息存储](#keft-1721932590686)

<a name="bgd6-1739985403138"></a>[生产者通过将消息追加到日志末尾来发送消息，消费者通过以此读取日志来接收消息。](#tlnm-1725029031868)

<a name="cjoe-1739985403140"></a>[Unix tail -f 监视文件被追加写入的数据就是这样工作的。](#1606-1725029123561)

<a name="krq3-1739985403142"></a>[Apache Kafka, Amazon Kinesis Streams , Twitter DistributedLog都是基于日志的消息代理](#aq8x-1725029525384)

<a name="ocms-1739985403144"></a>[Google Cloud Pub/Sub在架构上类似，单对外暴露的是JMS风格的API，而不是日志抽象](#0wz5-1725029598472)

<a name="bgmh-1739985403146"></a>[尽管写入磁盘，但通过跨多台机器分区，每秒能实现数百万消息的吞吐量，并通过复制来实现容错性。](#zqkl-1725029648581)

<a name="h8ct-1739985403148"></a>[日志与传统消息相比](#pr6y-1721932607757)

<a name="5x1j-1739985403150"></a>[天然支持扇出式消息传递：过个消费者独立读取日志，而不相互影响](#i3q5-1725115574888)

<a name="bm83-1739985403152"></a>[负载平衡：读取消息不会从日志中删除，代理可以将整个分区分配给消费者组中的节点，而不是单挑消息分配给客户端。](#ymqj-1725115609372)

<a name="qmfu-1739985403154"></a>[消费者偏移量](#o0ft-1721932621047)

<a name="iyt5-1739985403156"></a>[和单领导者数据库复制中常见的日志序列号非常相似，代理无需跟踪每条消息，只需定期记录消费者偏移即可。有助于提高基于日志的系统吞吐量](#emow-1725115793168)

<a name="wn3e-1739985403158"></a>[问题：消费者节点失效而没有记录偏移量，重启后这些消息将被处理两次。本章后续讨论。](#gmal-1725115911246)

<a name="5re4-1739985403160"></a>[磁盘空间使用](#ipmx-1721932629330)

<a name="nxgc-1739985403162"></a>[只追加写入日志，回收时将旧段删除或移动到归档存储](#5ep6-1725115987947)

<a name="dius-1739985403164"></a>[问题，消费者跟不上生产者，指向删除段，错过一些消息。](#kjgm-1725116313754)

<a name="mgcf-1739985403166"></a>[日志实现一个有限大小的缓冲区：循环缓冲区circular buffer/环形缓冲区，填满时将丢弃旧消息](#k3hi-1725116359622)

<a name="rr5n-1739985403168"></a>[设 大型硬盘容量为 6TB, 顺序写入为150MB/s， 最快需要约11小时填满磁盘，之后开始覆盖旧消息。实践中的部署很少能用满磁盘的写入带宽。所以通常可保留一个几天甚至几周的日志缓冲区](#jjma-1725116440115)

<a name="vz8m-1739985403170"></a>[以上保留多长时间的消息，日志吞吐量或多或少保持不变，因为每个消息都写入磁盘。](#bdoa-1725116521841)

<a name="isjx-1739985403172"></a>[   而默认将消息保存在内存中，当队列很短，系统很快；当系统开始写入磁盘，就慢得多，所以吞吐量取决于保留的历史数量。](#rxx7-1725116637183)

<a name="i8su-1739985403174"></a>[当消费者更不上生产者时](#91b6-1721932634947)

<a name="dy4o-1739985403176"></a>[3种选择：丢弃信息、进行缓冲或施加背压](#dztq-1725116764093)

<a name="8ss5-1739985403178"></a>[巨大运维优势：丢失消息仅影响当前消费者，不会中断其它消费者，可进行调试测试，不必中断生产服务。](#mgyh-1726767519795)

<a name="31cx-1739985403180"></a>[重播旧信息](#6tnb-1721932645175)

<a name="a3u4-1739985403182"></a>[删除消息：AMQP和JMS消息代理](#yygs-1726767645074)

<a name="8ni0-1739985403184"></a>[只读操作：基于日志的代理。](#u81b-1726767864887)

<a name="pq5i-1739985403186"></a>[更像上一章节的批处理。允许更多的实验操作，通过偏移量重播。](#opy5-1726767877078)

<a name="vmzz-1739985403188"></a>[流与数据库](#rnwj-1721932350699)

<a name="zqit-1739985403190"></a>[保持系统同步](#ehyq-1721932450135)

<a name="qyim-1739985403192"></a>[变更数据捕获](#1ako-1721932460819)

<a name="t7ma-1739985403194"></a>[变更数据捕获的实现](#xkpl-1721932670593)

<a name="fqag-1739985403196"></a>[初始快照](#uxpn-1721932683846)

<a name="qwbu-1739985403198"></a>[日志压缩](#j0w6-1721932690312)

<a name="zsh4-1739985403200"></a>[变更流的API支持](#5pqr-1721932694290)

<a name="cec0-1739985403202"></a>[事件溯源](#qkmx-1721932472062)

<a name="9fy0-1739985403204"></a>[从时间日志中派生出当前状态](#vydq-1721932714045)

<a name="rsac-1739985403206"></a>[命令和事件](#xbwr-1721932732154)

<a name="3lof-1739985403208"></a>[状态，流和不变形](#k3v8-1721932742549)

<a name="dxbd-1739985403210"></a>[从同一事件日志中派生多个视图](#diql-1721932751200)

<a name="6agd-1739985403212"></a>[并发控制](#tzcl-1721932772042)

<a name="ze7x-1739985403214"></a>[不变性的限制](#urmz-1721932775107)

<a name="t9ec-1739985403216"></a>[流处理](#nbcs-1721932419014)

<a name="npjb-1739985403218"></a>[流处理的应用](#jf4x-1721932507881)

<a name="xx0z-1739985403220"></a>[复合时间处理](#80rp-1721932792357)

<a name="b4je-1739985403222"></a>[流分析](#6jjt-1721932799443)

<a name="36m5-1739985403224"></a>[维护物化视图](#5iog-1721932801692)

<a name="npo9-1739985403226"></a>[在流上搜索](#0asi-1721932807278)

<a name="mlhj-1739985403228"></a>[消息传递和RPC](#10bm-1721932817553)

<a name="yfuq-1739985403230"></a>[时间推理](#oca5-1721932519502)

<a name="ppba-1739985403232"></a>[事件时间和处理时间](#is6l-1721932844579)

<a name="qpzu-1739985403234"></a>[知道什么时候准备好](#aue5-1721932851975)

<a name="gddy-1739985403236"></a>[你用的是谁的时钟](#vsi1-1721932859473)

<a name="am7n-1739985403238"></a>[窗口的类型](#gryf-1721932868260)

<a name="3cq7-1739985403240"></a>[流式连接](#jbet-1721932523864)

<a name="xgkw-1739985403242"></a>[流流连接(窗口连接)](#eaux-1721932880085)

<a name="yewg-1739985403244"></a>[流表连接(流扩展)](#hixz-1721932915139)

<a name="xlwd-1739985403246"></a>[表表连接(维护物化视图)](#zbsv-1721932945841)

<a name="sqcl-1739985403248"></a>[连接的时间依赖性](#xqtb-1721932962310)

<a name="kaqy-1739985403250"></a>[容错](#v1om-1721932530009)

<a name="stvk-1739985403252"></a>[微批量与存档点](#pqfe-1721932996846)

<a name="qinq-1739985403254"></a>[原子提交再现](#elio-1721933013244)

<a name="sghr-1739985403256"></a>[幂等性](#bwyd-1721933023622)

<a name="t7vn-1739985403258"></a>[失败后重建状态](#dijm-1721933026909)

<a name="fx67-1739985403260"></a>[12. 数据系统的未来](#vrhs-1739552413424)

<a name="zyfm-1739985403262"></a>[数据集成](#ede5-1739555478378)

<a name="cmcr-1739985403264"></a>[组合使用衍生数据的工具](#72md-1739555630486)

<a name="jw6a-1739985403266"></a>[理解流数据](#ws0u-1739555668111)

<a name="ojqg-1739985403268"></a>[衍生数据与分布式事务](#zqyv-1739555677949)

<a name="9v7c-1739985403270"></a>[全局有序的限制](#sdr6-1739555687850)

<a name="28zp-1739985403272"></a>[排序事件以捕捉因果关系](#zk4p-1739555695102)

<a name="eddr-1739985403274"></a>[批处理与流处理](#niva-1739555642700)

<a name="yzlo-1739985403276"></a>[维护衍生状态](#r4mh-1739555731398)

<a name="pdbv-1739985403278"></a>[应用演化后重新处理数据](#dx0m-1739555748166)

<a name="3vee-1739985403280"></a>[Lambda架构](#2vm7-1739555772929)

<a name="lsqh-1739985403282"></a>[统一批处理和流处理](#6flf-1739555780198)

<a name="sbd7-1739985403284"></a>[分拆数据库](#10z2-1739555560574)

<a name="o9zn-1739985403286"></a>[组合使用数据存储技术](#8wfw-1739555819342)

<a name="w6vy-1739985403288"></a>[创建索引](#havr-1739555874428)

<a name="biip-1739985403290"></a>[一切的元数据库](#ep2e-1739555885454)

<a name="xfrp-1739985403292"></a>[开展分拆工作](#am3j-1739555961678)

<a name="6ang-1739985403294"></a>[分拆系统和集系统](#trtv-1739555969624)

<a name="0ecz-1739985403296"></a>[少了什么？](#lcy6-1739555980725)

<a name="nhsh-1739985403298"></a>[围绕数据流设计应用](#97j6-1739555836550)

<a name="vhmo-1739985403300"></a>[应用代码所谓衍生函数](#gyfk-1739555997047)

<a name="rlip-1739985403302"></a>[应用代码的状态和分离](#2njs-1739556023517)

<a name="vtta-1739985403304"></a>[数据流：应用代码与状态变化的交互](#pgmn-1739556032065)

<a name="cfxh-1739985403306"></a>[流处理器和服务](#fyub-1739556046567)

<a name="7p6a-1739985403308"></a>[观察衍生数据状态](#dmmo-1739555844651)

<a name="wvnh-1739985403310"></a>[物化视图和缓存](#48oq-1739556059722)

<a name="niw3-1739985403312"></a>[有状态，可离线的客户端](#srii-1739556068892)

<a name="stal-1739985403314"></a>[将状态变更推送给客户端](#zdkz-1739556083230)

<a name="k7tz-1739985403316"></a>[端到端的事件流](#70bj-1739556096239)

<a name="r7zr-1739985403318"></a>[读也是事件](#k9nk-1739556109784)

<a name="ost5-1739985403320"></a>[多分区处理数据](#rknv-1739556117246)

<a name="hgo7-1739985403322"></a>[将事情做正确](#ydeg-1739555534326)

<a name="xcuw-1739985403324"></a>[为数据库使用端到端的参数](#bool-1739556139461)

<a name="mtey-1739985403326"></a>[正好执行一次操作](#utq9-1739556271989)

<a name="aq7b-1739985403328"></a>[抑制重复](#mxfy-1739556285089)

<a name="c2bp-1739985403330"></a>[操作标识符](#9kug-1739556293281)

<a name="taas-1739985403332"></a>[在数据系统中应用端到端的思考](#dc4e-1739556300938)

<a name="7fai-1739985403334"></a>[强制约束](#cai0-1739556155120)

<a name="zsi4-1739985403336"></a>[唯一性的约束要达成共识](#jeqp-1739556425758)

<a name="0nuy-1739985403338"></a>[基于日志消息传递中的唯一性](#lcq0-1739556436827)

<a name="ssxm-1739985403340"></a>[多分区请求处理](#dk4a-1739556687945)

<a name="agcd-1739985403342"></a>[及时性与完整性](#dbka-1739556159893)

<a name="92ed-1739985403344"></a>[数据流系统的正确性](#bmr3-1739556705098)

<a name="kbkr-1739985403346"></a>[宽松地解释约束](#loih-1739556715504)

<a name="mfi6-1739985403348"></a>[无协调数据系统](#v94l-1739556733932)

<a name="npy8-1739985403350"></a>[信任但验证](#boru-1739556172269)

<a name="jaij-1739985403352"></a>[维护完整性，尽管软件有bug](#zgrh-1739556749129)

<a name="bmyz-1739985403354"></a>[不要盲目信任任何承诺](#irhz-1739556777111)

<a name="50vv-1739985403356"></a>[验证的文化](#1d8z-1739556789067)

<a name="1ff6-1739985403358"></a>[为可审计性而设计](#61de-1739556792067)

<a name="vtsd-1739985403360"></a>[端到端原则重现](#guck-1739556800394)

<a name="nlma-1739985403363"></a>[利用可审计数据系统的工具](#tjmv-1739556812856)

<a name="lj15-1739985403365"></a>[做正确的事情](#dizf-1739555546308)

<a name="l4g9-1739985403367"></a>[预测性分析](#va2h-1739556847417)

<a name="0m7v-1739985403369"></a>[偏见与分析](#c1wq-1739556910451)

<a name="hg67-1739985403371"></a>[责任与问责](#ijng-1739556917694)

<a name="s9kc-1739985403373"></a>[反馈循环](#thso-1739556928624)

<a name="46uo-1739985403375"></a>[隐私和追踪](#gt9r-1739556854431)

<a name="4nlu-1739985403377"></a>[监视](#qol8-1739556939696)

<a name="6gby-1739985403379"></a>[同意与选择的自由](#zgzn-1739556948482)

<a name="a9j7-1739985403381"></a>[隐私和数据使用](#ewvo-1739557089382)

<a name="twyl-1739985403383"></a>[数据资产与权力](#vlsj-1739557096182)

<a name="2pw4-1739985403385"></a>[记着工业革命](#muzc-1739557108489)

<a name="zp0m-1739985403387"></a>[立法与法律](#7mjx-1739557115858)

<a name="qjxo-1739985403389"></a>[本章小结](#hmh3-1739556886643)
...
<a name="q4ii-1740155028973"></a>**日志结构**

<a name="0hl1-1740155034913"></a>**面相页面：B树**
...
<a name="wwhy-1740155355395"></a>**key  ：byte offset    -key的字节偏移量（检索到对应的key位置）**
...
<a name="cecn-1740225640452"></a>**内存中为有序key : byte offset,   每个key是disk每段的头节点**
